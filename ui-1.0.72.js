...
(THREE.EditorControls = function (e, t) {
        ...
        if (false !== EC.enabled) {
            switch (e.touches.length) {
                case 1:
                    ...
                    break;
                case 2:
                    g[0].set(e.touches[0].pageX, e.touches[0].pageY, 0), g[1].set(e.touches[1].pageX, e.touches[1].pageY, 0), (v = g[0].distanceTo(g[1]));
            }
    ...
    function P(e) {
        ...
        function r(e, t) {
            var i = t[0];
            for (var s in t) i.distanceTo(e) > t[s].distanceTo(e) && (i = t[s]);
            return i;
        }
    }
        ...
        (THREE.TransformGizmo = function () {
            ...
            (THREE.TransformGizmoTranslate = function () {
                ...
                o.addAttribute("position", new THREE.Float32BufferAttribute([0, 0, 0, 0, 0, 1], 3)),
                    ...
                    (this.pickerGizmos = {
                        ...
                        XZ: [[new THREE.Mesh(new THREE.PlaneBufferGeometry(0.4, 0.4), i), [0.2, 0, 0.2], [-Math.PI / 2, 0, 0]]],
                    }),
            ...
            (THREE.TransformGizmoRotate = function () {
                ...
                var e = function (e, t, i) {
                    ...
                    return s.addAttribute("position", new THREE.Float32BufferAttribute(n, 3)), s;
                };
                (this.handleGizmos = {
                    ...
                    (this.pickerGizmos = {
                        X: [[new THREE.Mesh(new THREE.TorusBufferGeometry(1, 0.12, 4, 12, Math.PI), i), [0, 0, 0], [0, -Math.PI / 2, -Math.PI / 2]]],
                        Y: [[new THREE.Mesh(new THREE.TorusBufferGeometry(1, 0.12, 4, 12, Math.PI), i), [0, 0, 0], [Math.PI / 2, 0, 0]]],
                        Z: [[new THREE.Mesh(new THREE.TorusBufferGeometry(1, 0.12, 4, 12, Math.PI), i), [0, 0, 0], [0, 0, -Math.PI / 2]]],
                        E: [[new THREE.Mesh(new THREE.TorusBufferGeometry(1.25, 0.12, 2, 24), i)]],
                    ...
                    (this.update = function (e, t) {
                        ...
                        s.copy(this.planes.XY.rotation),
                            ...
                            this.traverse(function (e) {
                                n.setFromEuler(s),
                                    "X" === e.name && (l.setFromAxisAngle(r, Math.atan2(-p.y, p.z)), n.multiplyQuaternions(n, l), e.quaternion.copy(n)),
                                    "Y" === e.name && (h.setFromAxisAngle(a, Math.atan2(p.x, p.z)), n.multiplyQuaternions(n, h), e.quaternion.copy(n)),
                                    "Z" === e.name && (c.setFromAxisAngle(o, Math.atan2(p.y, p.x)), n.multiplyQuaternions(n, c), e.quaternion.copy(n));
                            });
                    }),
                    this.init();
            }),
            ...
            (THREE.TransformGizmoScale = function () {
                THREE.TransformGizmo.call(this);
                var s = new THREE.Geometry(),
                    n = new THREE.Mesh(new THREE.BoxGeometry(0.125, 0.125, 0.125));
                (n.position.y = 0.5), n.updateMatrix(), s.merge(n.geometry, n.matrix);
                var r = new THREE.BufferGeometry();
                r.addAttribute("position", new THREE.Float32BufferAttribute([0, 0, 0, 1, 0, 0], 3));
                var a = new THREE.BufferGeometry();
            ...
            (THREE.TransformControls = function (e, t) {
                ...
                for (var a in r) {
                    var o = r[a];
                    (o.visible = a === s), this.add(o);
                }
                var l = { type: "change" },
                    h = { type: "mouseDown" },
                    c = { type: "mouseUp", mode: s },
                    p = { type: "objectChange" },
                        ...
                        false !== t &&
                            ...
                            "translate" === s
                                ? (m.sub(f),
                                  ...
                                  ("world" !== i.space && -1 === i.axis.search("XYZ")) ||
                                      (-1 === i.axis.search("X") && (m.x = 0),
                                      -1 === i.axis.search("Y") && (m.y = 0),
                                      -1 === i.axis.search("Z") && (m.z = 0),
                                      ...
                                      i.object.position.copy(L),
                                      i.object.position.add(m)),
                                  null !== i.translationSnap &&
                                      ("local" === i.space && i.object.position.applyMatrix4(P.getInverse(D)),
                                      ...
                                      "local" === i.space && i.object.position.applyMatrix4(D)))
                                : "scale" === s
                                ? (m.sub(f),
                                  m.multiply(O),
                                  "local" === i.space &&
                                      ("XYZ" === i.axis
                                          ? ((b = 1 + m.y / Math.max(A.x, A.y, A.z)), (i.object.scale.x = A.x * b), (i.object.scale.y = A.y * b), (i.object.scale.z = A.z * b))
                                          : (m.applyMatrix4(P.getInverse(D)),
                                            "X" === i.axis && (i.object.scale.x = A.x * (1 + m.x / A.x)),
                                            "Y" === i.axis && (i.object.scale.y = A.y * (1 + m.y / A.y)),
                                            "Z" === i.axis && (i.object.scale.z = A.z * (1 + m.z / A.z)))))
                                : "rotate" === s &&
                                  (m.sub(I),
                                  m.multiply(O),
                                  k.copy(f).sub(I),
                                  ...
                                  "E" === i.axis
                                      ...
                                      ? (m.applyMatrix4(P.getInverse(D)),
                                        ...
                                        null !== i.rotationSnap
                                            ? (Z.setFromAxisAngle(w, Math.round((y.x - g.x) / i.rotationSnap) * i.rotationSnap),
                                              _.setFromAxisAngle(C, Math.round((y.y - g.y) / i.rotationSnap) * i.rotationSnap),
                                              j.setFromAxisAngle(z, Math.round((y.z - g.z) / i.rotationSnap) * i.rotationSnap))
                                            : (Z.setFromAxisAngle(w, y.x - g.x), _.setFromAxisAngle(C, y.y - g.y), j.setFromAxisAngle(z, y.z - g.z)),
                ...
                t.addEventListener("mousedown", K, false),
                    ...
                    (this.setMode = function (e) {
                        for (var t in ("scale" === (s = e || s) && (i.space = "local"), r)) r[t].visible = t === s;
                        this.update(), i.dispatchEvent(l);
                    }),
                    ...
                    (this.setSize = function (e) {
                        (i.size = e), this.update(), i.dispatchEvent(l);
                    }),
...
(PZ.ui.generateIcon = function (e) {
    ...
    return i.setAttributeNS("http://www.w3.org/1999/xlink", "href", PZ_ICONS + "#" + e), t.appendChild(i), t;
}),
    ...
    (PZ.ui.audioMeter.prototype.update = function () {
        (this.animFrameReq = requestAnimationFrame(this._updateFn)), this.analyzer.getByteTimeDomainData(this.audioData);
        let e = 0,
            t = 0;
        for (var i = 0; i < this.audioData.length; i++) {
            let s = 2 * Math.abs(this.audioData[i] / 256 - 0.5);
            (t += s * s), (e = Math.max(e, s));
        }
        (t = Math.sqrt(t / this.audioData.length)), (this.ampEl.style.transform = "scaleY(" + (1 - t) + ")"), (this.peak = Math.max(e, this.peak - 0.01 / Math.exp(this.peak))), (this.peakEl.style.bottom = 100 * this.peak + "%");
    }),
    (PZ.ui.editor = function () {
        PZ.observable.defineObservableProp(this, "sequence", "onSequenceChanged"),
            ...
            this.onProjectChanged.watch(
                function () {
                    this.project && (this.project.assets.onAssetRemoved.watch(this.assetRemoved.bind(this)), (this.sequence = this.project.sequence));
                }.bind(this)
            ),
            PZ.observable.defineObservableProp(this, "enabled", "onEnabledChanged"),
            this.onEnabledChanged.watch(() => {
                this.windows.forEach((e) => (e.enabled = this.enabled)), (this.playback.enabled = this.enabled);
            }),
            (this.windows = []),
    ...
    (PZ.ui.editor.prototype.sendDiagnostics = function () {
        ...
        try {
            PZ.api("/feedback/diagnostics", "post", { feedbackSource: 0, feedbackType: 9, feedbackCategory: 0, toolVersion: PZVERSION, message: e });
        } catch (e) {}
    }),
    ...
    (PZ.ui.editor.prototype.closeAllWindows = function () {
        for (var e = 0; e < this.windows.length; e++) this.windows[e].secondary && this.windows[e].window.close();
    }),
    (PZ.ui.editor.prototype.keydown = function (e) {
        if (!e.ctrlKey) return;
        if (PZ.ui.toolbar.prototype.shouldIgnoreKeydown(e.target, e.key)) return;
        let t = e.key.toLowerCase();
        if ("n" === t || "m" === t) this.new();
        else if ("o" === t) this.open();
        else if ("s" === t) this.save(e.shiftKey);
        else if ("z" === t) this.history.undo();
        else {
            if ("y" !== t) return;
            this.history.redo();
        }
    ...
    (PZ.ui.editor.prototype.showFilePicker = function (e, t, i) {
        (this.fileInput.value = null), (this.fileInput.onchange = e), t ? this.fileInput.setAttribute("accept", t) : this.fileInput.removeAttribute("accept"), this.fileInput.setAttribute("multiple", !!i), this.fileInput.click();
    }),
    ...
    (PZ.ui.editor.prototype.loadProject = async function (e) {
        let t = await PZ.project.load(e),
            i = new PZ.project();
        return t.media.splice(0, 0, ...this.defaultProject.media), i.load(t, e), i;
    }),
        ...
        this.confirmIfDirty() &&
            this.showFilePicker(async (e) => {
                ...
                if (t && t[0]) {
                    ...
                    await e.untar(t[0]), (this.project = await this.loadProject(e));
                }
            }, ".pz");
    }),
    ...
    (PZ.ui.editor.prototype.getCreationFromUrl = async function () {
        ...
        if ((sessionStorage.getItem("loadTemplate") && sessionStorage.removeItem("loadTemplate"), !t)) return;
        let i = await fetch(PZ.blobOrigin + "/creations/" + t + ".pz");
        if (200 === i.status) {
            let e = await i.blob(),
                t = new PZ.archive();
            return await t.untar(e), await this.loadProject(t);
        }
    }),
    (PZ.ui.window = function (e, t) {
        ...
        this.el.addEventListener(
            ...
            function (e) {
                if (!e.altKey && "Backquote" === e.code) {
                    ...
                    if (e.ctrlKey && e.shiftKey) {
                        ...
                        this.oldPanel
                            ? ((this.panel = null), i.oldParent.appendChild(i.el), delete i.oldParent, this.setPanel(this.oldPanel), delete this.oldPanel)
            ...
            this.window.addEventListener(
                "resize",
                function () {
                    clearTimeout(this.resizeTimeout), (this.resizeTimeout = setTimeout(this.resize.bind(this), 500));
                }.bind(this)
            ),
            this.window.addEventListener(
                "unload",
    ...
    (PZ.ui.panel.nav = class extends PZ.ui.panel {
        constructor(e) {
            super(e), (this.currentPage = null), (this.pageBackStack = []);
        }
        navigate(e, t) {
        ...
        createPage(e, t, i) {
            ...
            if (e) {
                ...
                t && n.insertBefore(this.createBackButton(i), n.firstElementChild), s.appendChild(n);
            }
            return s;
        }
    }),
    (PZ.fixedStack = function (e) {
        (this.stack = new Array(e)), (this.length = 0), (this.idx = 0);
    }),
    ...
    (PZ.fixedStack.prototype.push = function (e) {
        (this.stack[this.idx] = e), (this.length = Math.min(this.stack.length, this.length + 1)), (this.idx = (this.idx + 1) % this.stack.length);
    }),
    (PZ.fixedStack.prototype.pop = function () {
        if (!this.length) return;
        (this.idx = ((e, t) => ((e % t) + t) % t)(this.idx - 1, this.stack.length)), (this.length -= 1);
        let e = this.stack[this.idx];
        return (this.stack[this.idx] = null), e;
    }),
    ...
    (PZ.ui.splitPanel.prototype.resize = function () {
        if (((this.direction = this.options.direction), -1 === this.options.direction && (this.direction = this.el.clientWidth > this.el.clientHeight ? 1 : 0), 0 === this.direction)) {
            let e = this.el.clientHeight,
                t = 0.5 * this.splitSize,
                i = e * this.ratio - t,
                s = e * this.ratio + t;
        ...
        this.panels[0].resize(), this.panels[1].resize();
    }),
    (PZ.ui.splitPanel.prototype.dragStart = function (e) {
        (this.lastPt = { x: e.pageX, y: e.pageY }), (this.currentPt = { x: e.pageX, y: e.pageY });
    }),
    (PZ.ui.splitPanel.prototype.drag = function (e) {
        (this.currentPt.x = e.pageX), (this.currentPt.y = e.pageY);
    }),
    (PZ.ui.splitPanel.prototype.dragUpdate = function () {
        ...
        if (0 === e.direction) {
            ...
            (e.panels[0].el.style.height = parseFloat(e.panels[0].el.style.height) + t + "px"),
                ...
                (e.ratio = (parseFloat(e.panels[0].el.style.height) + 0.5 * e.splitSize) / e.el.clientHeight);
        } else {
            ...
            (e.panels[0].el.style.width = parseFloat(e.panels[0].el.style.width) + t + "px"),
                ...
                (e.ratio = (parseFloat(e.panels[0].el.style.width) + 0.5 * e.splitSize) / e.el.clientWidth);
        }
        (this.lastPt.x = this.currentPt.x), (this.lastPt.y = this.currentPt.y);
    }),
    ...
    (PZ.ui.elevator = class extends PZ.ui.panel {
        constructor(e, t) {
            super(e),
                ...
                this.create(),
                this.onEnabledChanged.watch(() => {
                    (this.activePanel.enabled = this.enabled), this.tabLock(!this.enabled);
                }),
        ...
        buttonKeyDown(e) {
            ...
            "ArrowUp" === e.key
                ? t.previousElementSibling && (t.removeAttribute("tabindex"), t.previousElementSibling.setAttribute("tabindex", 0), t.previousElementSibling.focus())
                : "ArrowDown" === e.key
                ? t.nextElementSibling && (t.removeAttribute("tabindex"), t.nextElementSibling.setAttribute("tabindex", 0), t.nextElementSibling.focus())
                : "Enter" === e.key && t.click();
        }
        selectionChanged() {
            for (var e = this.sequence.ui.selection, t = this.tabcontainer.getElementsByClassName("selected")[0], i = 0; i < this.tabcontainer.children.length; i++) {
                ...
                if (s.pz_tab.selectionChanged)
                    s.pz_tab.selectionChanged(e) ? (s.classList.remove("nocontext"), s.pz_tab.hideIfNoContext && (s.style.display = "")) : (s.classList.add("nocontext"), s.pz_tab.hideIfNoContext && (s.style.display = "none")),
                        t === s && this.changeTab(s);
            }
        }
        create() {
            (this.container = document.createElement("div")), this.container.classList.add("elevator"), this.el.appendChild(this.container);
            ...
            t.classList.add("elevatorcontrols"), this.el.appendChild(t);
            for (var i = 0; i < this.panels.length; i++) {
                let e = this.panels[i].el;
                (e.style.width = "100%"), (e.style.height = "100%"), (e.style.display = "none"), t.appendChild(e);
                ...
                (r.innerText = this.panels[i].title), s.appendChild(r), this.tabcontainer.appendChild(s);
            }
        }
        toggle(e) {
    ...
    (PZ.ui.edit.prototype = {
        ...
        moveObject(e) {
            ...
            void 0 === e.newIdx && (e.newIdx = i.length),
                ...
                this.editor.history.pushCommand(PZ.ui.edit.prototype.moveObject.bind(this), { oldParentAddress: e.newParentAddress, oldIdx: e.newIdx, newParentAddress: e.oldParentAddress, newIdx: e.oldIdx });
        },
        deleteObject(e) {
            let t = this.editor.project.addressLookup(e.oldParentAddress),
                i = t[e.oldIdx];
            i.unload(), t.splice(e.oldIdx, 1), this.editor.history.pushCommand(PZ.ui.edit.prototype.createObject.bind(this), { newParentAddress: e.oldParentAddress, newIdx: e.oldIdx, baseType: t.type, subType: i.type, data: i });
        },
        generateAdd: function (e, t) {
            ...
            h.classList.add("proprow", "propbutton", "noselect"),
                (h.innerText = "Cancel"),
                (h.onclick = () => {
                    s.remove(), (this.el.firstElementChild.style.display = ""), (this.el.scrollTop = i.top), (this.el.scrollLeft = i.left);
                }),
                s.appendChild(h);
            ...
            (c = document.createElement("input")).setAttribute("type", "text"),
                ...
                (h.onkeydown = function (e) {
                    "Escape" === e.key || "Enter" === e.key ? h.click() : (c.focus(), c.dispatchEvent(new KeyboardEvent(e.type, e))), e.stopPropagation();
                }),
                (c.onkeyup = (e) => {
                    let t = c.value;
                    if (t !== l) {
                        for (l = t; p.children.length; ) p.children[0].classList.remove("active"), p.children[0].remove();
                        "" !== t ? (a.search(t).forEach((e) => !e.category && p.appendChild(o.get(e))), p.firstElementChild && p.firstElementChild.classList.add("active")) : n.forEach((e) => p.appendChild(o.get(e)));
                    }
                }),
                (c.onkeydown = (e) => {
                    ...
                    if ("ArrowUp" === e.key) {
                        ...
                        if ("Enter" !== e.key) return;
                        {
                            let i = t.querySelector(".active");
                            if (!i) return;
                            i.dispatchEvent(new MouseEvent("click", { ctrlKey: e.ctrlKey }));
                        }
                    }
                    e.stopPropagation();
                });
            let p = document.createElement("ul");
            p.classList.add("pz-options", "noselect"), (p.style = "overflow-y: auto;"), s.appendChild(p);
            let d = (t) => {
                    let i = document.createElement("li"),
                        s = document.createTextNode(t.name);
                    if ((i.appendChild(s), t.desc)) {
                        let e = document.createElement("span");
                        (e.innerText = t.desc), i.appendChild(e);
                    }
                    return (
                        (i.pz_item = t),
                        (i.onclick = async (t) => {
                            let i = t.currentTarget.pz_item;
                            if (i.list && (!i.hidelist || t.ctrlKey)) return (n = i.list), (a = new Fuse(n, r)), (o = new Map()), (l = ""), (c.value = ""), void m();
                            let s = i.data;
                            "function" == typeof s && (s = await s.call(this)),
                                this.editor.history.startOperation(),
                                e instanceof PZ.objectSingleton && e.length > 0 && this.deleteObject({ oldParentAddress: e.getAddress(), oldIdx: 0 }),
                                this.createObject({ newParentAddress: e.getAddress(), baseType: e.type, subType: i.type, data: s }),
        ...
        generateChildrenList: function (e, t) {
            t instanceof PZ.object && (t = [t]), e.classList.add("parent");
            let i = document.createElement("ul");
            i.pz_paddingLevel = e.parentElement.pz_paddingLevel + 15;
            for (let e = 0; e < t.length; e++) this.generateListItem(i, t[e]);
            e.parentElement.insertBefore(i, e.nextElementSibling);
        },
        generateObjectList: function (e, t) {
            e.classList.add("parent");
            let i = document.createElement("ul");
            if (((i.pz_paddingLevel = e.parentElement.pz_paddingLevel + 15), this.options.showPropertyControls && (t.type === PZ.property || t.type === PZ.property.dynamic))) {
                this.propertyListEls.push(i);
                let e = new PZ.ui.controls(this.editor, t);
                (e.el = i), (i.pz_controls = e);
            }
        ...
        generatePropertyList: function (e, t) {
            e.classList.add("parent");
            let i = document.createElement("ul");
            (i.pz_paddingLevel = e.parentElement.pz_paddingLevel + 15), this.options.showPropertyControls && this.propertyListEls.push(i);
        ...
        generateButton: function (e) {
            ...
            return (i.style = "width:17px;height:17px;fill:#ccc;"), t.classList.add("actionbutton"), t.appendChild(i), t;
        },
            ...
            let r = i.get(),
                a = () => {
                    ...
                    n.remove(),
                        ...
                        e !== r && (this.editor.history.startOperation(), this.propertyOps.setValue({ property: i.getAddress(), value: e, oldValue: r }), this.editor.history.finishOperation());
                };
            (n.onmousedown = n.onclick = n.ontouchstart = function (e) {
                e.stopPropagation();
            }),
                (n.onkeydown = function (e) {
                    "Enter" === e.key ? (this.blur(), e.preventDefault()) : "Escape" === e.key && ((this.value = r), this.blur(), e.preventDefault()), e.stopPropagation();
                }),
                (n.onblur = function (e) {
                    a();
                }),
        ...
        collapseClick: function (e) {
            ...
            this.classList.contains("collapsed") ? (this.classList.remove("collapsed"), (t.nextElementSibling.style.display = "")) : (this.classList.add("collapsed"), (t.nextElementSibling.style.display = "none")), e.stopPropagation();
        },
        generateItemCommands: function (e, t) {
            let i = e.children[1],
                s = i.firstElementChild;
            if (!(t instanceof PZ.property || this.options.hideAllListItemButtons))
                if ((i.classList.add("actions"), t instanceof PZ.propertyList)) {
                    let e = this.generateButton("reset");
                    (e.title = "reset"),
                        (e.onclick = (e) => {
                            this.editor.history.startOperation(), this.propertyOps.resetAll(t), this.editor.history.finishOperation();
                        }),
                        i.insertBefore(e, s);
                    ...
                    if (!(t.parent instanceof PZ.objectSingleton)) {
                        ...
                        (e.title = "clone"),
                            (e.onclick = (e) => {
                                ...
                                if (!(t.parent instanceof PZ.objectList)) return;
                                let i = t.getAddress(),
                                    s = { newParentAddress: i, newIdx: i.pop() + 1, baseType: t.parent.type, subType: t.type, data: JSON.parse(JSON.stringify(t)) };
                                this.editor.history.startOperation(), this.createObject(s), this.editor.history.finishOperation(), e.stopPropagation();
                            }),
                            i.insertBefore(e, s);
                    }
                    ...
                    (e.title = "delete"),
                        (e.onclick = (e) => {
                            ...
                            if (!(t.parent instanceof PZ.objectList)) return;
                            let i = t.getAddress(),
                                s = { oldParentAddress: i, oldIdx: i.pop() };
                            this.editor.history.startOperation(), this.deleteObject(s), this.editor.history.finishOperation(), e.stopPropagation();
                        }),
                        i.insertBefore(e, s);
                }
        },
        generateListItem: function (e, t, i) {
            ...
            (a.style.pointerEvents = "none"), r.appendChild(a), s.appendChild(r);
            let o = document.createElement("div");
            s.appendChild(o), this.generateItemCommands(s, t);
                    ...
                    this.options.showPropertyControls &&
                        ...
                        t.onAnimatedChanged &&
                            ((s.pz_animatedChanged = () => {
                                r.getElementsByClassName("actionbutton")[0].remove(), (o.innerHTML = ""), PZ.ui.controls.createControls(s, t, this.options.hideAnimateToggle);
                            }),
            ...
            if (n) {
                ...
                (e.innerText = "⯆"),
                    ...
                    t instanceof PZ.property.dynamic.group && (e.classList.add("collapsed"), (s.nextElementSibling.style.display = "none"));
            } else r.style.paddingLeft = parseFloat(r.style.paddingLeft) + 20 + "px";
            return s;
        },
        unloadListItem: function (e) {
            let t = e.nextElementSibling;
            if (t && "UL" === t.tagName) {
                for (; t.children.length; ) this.unloadListItem(t.children[0]);
                t.pz_objectAdded && (t.pz_object.onObjectAdded.unwatch(t.pz_objectAdded), t.pz_object.onObjectRemoved.unwatch(t.pz_objectRemoved)),
                    t.pz_listChanged && t.pz_object.onListChanged.unwatch(t.pz_listChanged),
                    this.options.showPropertyControls &&
                        (t.pz_object instanceof PZ.propertyList || (t.pz_object instanceof PZ.objectList && (t.pz_object.type === PZ.property || t.pz_object.type === PZ.property.dynamic))) &&
        ...
        objectsChanged: function () {
            for (; this.list.children.length; ) this.unloadListItem(this.list.children[0]);
            this.emptyMessage.nextElementSibling && (this.emptyMessage.nextElementSibling.remove(), (this.el.firstElementChild.style.display = ""));
            ...
            } else this.emptyMessage.style.display = "";
        },
        create: function () {
        ...
        keydown: async function (e) {
            ...
            if ("c" === t || "x" === t) {
                ...
                let e = new PZ.package(this.selection),
                    i = JSON.stringify([e]);
                if ((navigator.clipboard.writeText(i), "x" === t)) {
                ...
                let s,
                    n = (e) => {
                        let t,
                            s,
                            n = e.getAddress();
                        e instanceof PZ.objectList || ((e = e.parent), (t = n.pop() + 1)), (s = e.type);
                ...
                for (let e = 0; e < s.length; e++) {
                    let t = s[e];
                    if (t instanceof PZ.object) for (let e = 0; e < t.children.length; e++) t.children[e] instanceof PZ.objectList && n(t.children[e]);
        ...
        update: function () {
            ...
            for (let t = 0; t < this.propertyListEls.length; t++) this.updatePropertyList(this.propertyListEls[t], e);
        },
        ...
        setColumnTemplate: function (e) {
            ...
            for (let i = 0; i < t.length; i++) t[i].style.gridTemplateColumns = e;
            this.columnTemplate = e;
        },
        selectItems: function () {
            let e = this.list.getElementsByClassName("selected");
            (e = Array.from(e).map((e) => e.pz_object)), this.selection.splice(0, this.selection.length, ...e);
        },
        deselectItems: function () {
            let e = this.list.getElementsByClassName("selected");
            for (; e.length; ) e[0].classList.remove("selected");
        },
        columnDragStart: function (e) {
            (this.startPt = e.pageX), (this.currentPt = e.pageX), (this.startScroll = this.ctx.el.scrollLeft), (this.startLeft = this.ctx.columnAdjust.offsetLeft);
        },
        ...
        itemDrag: function (e) {
            (this.currentPt = e.pageY), (this.target = e.target);
        },
        itemDragUpdate: function () {
            ...
            if (i) {
                if (n < s)
                    return (
                        this.target.parentElement.insertBefore(this.indicatorEl, this.target),
                ...
                if (1 - n < s)
                    return (
                        this.target.parentElement.insertBefore(this.indicatorEl, this.target.nextElementSibling),
                        (this.indicatorEl.style.height = "3px"),
                        (this.indicatorEl.style.marginTop = "-3px"),
                        (this.indicatorEl.style.top = "1px"),
        ...
        itemDragEnd: function (e) {
            if (
                ...
                let t,
                    i,
                    s = this.item.pz_object;
                if (e.altKey) (t = this.ctx.createObject), (i = { baseType: s.parent.type, subType: s.type, data: s });
                else {
                ...
                if (3 === this.operation) {
                    ...
                    (i.newIdx = t.indexOf(this.target)), 2 === this.operation && (i.newIdx += 1);
                }
                if (t === this.ctx.moveObject) {
                    let e = [...i.oldParentAddress, i.oldIdx],
                        t = i.newParentAddress;
                    if (e.every((e, i) => e === t[i])) return;
                }
                this.ctx.editor.history.startOperation(), t.call(this.ctx, i), this.ctx.editor.history.finishOperation();
            }
        },
        resize() {
            this.columnTemplate ||
                ...
                2 === this.options.columnLayout
                    ...
                    : ((this.columnAdjust.style.left = this.options.defaultColumnWidth), this.setColumnTemplate(this.options.defaultColumnWidth + " auto")));
        },
    }),
    (PZ.ui.edit.importOBJ = async function () {
        let e,
            t = (e = await new Promise((e, t) => {
        ...
        e = await new Promise((e, s) => {
            (i.onload = e), i.readAsText(t[0]);
        });
        try {
            let t = new THREE.OBJLoader().parse(e.target.result),
                i = { properties: { name: s }, objects: [] };
            for (let e = 0; e < t.children.length; e++) {
                let s = { type: 0, objectType: 99, properties: { name: t.name || "Geometry", geometryProperties: {} } };
                var n = new Blob([JSON.stringify(t.children[e].geometry)], { type: "application/json" }),
                    r = await this.editor.project.assets.createFromFile(PZ.asset.type.GEOMETRY, n);
                (s.properties.geometryProperties.customGeometry = r), i.objects.push(s);
            }
            return i;
        } catch (e) {
            console.log(e);
    ...
    (PZ.ui.edit.importImage = async function () {
        ...
        return await new Promise(function (e, t) {
            (s.onload = async function () {
                var t = this.width,
                    s = this.height;
                if (0 === t || 0 === s) return void e();
                let n = { effects: [], properties: { childProperties: { image: i.key }, resolution: [t, s] } };
                (this.onload = null), e(n);
            }),
                (s.src = i.url);
        });
    }),
    ...
    PZ.ui.objectTypes.set(PZ.effect, [
        ...
        { name: "Color Grading", desc: "Adjust the grading of shadows, midtones, and highlights.", type: "colorgrading" },
        { name: "Color Adjustment", desc: "Add, multiply, and exponentiate colors to adjust appearance.", type: "colorcorrection" },
    ...
    (PZ.ui.controls = function (e, t) {
        (this.editor = e), (this.propertyOps = new PZ.ui.properties(this.editor)), (this.properties = t);
    }),
    (PZ.editor = {}),
        ...
        if (void 0 === PZ.editor.easeDropDown) {
            (t = PZ.editor.easeDropDown = document.createElement("ul")).classList.add("pz-dropdown"),
                ...
                (t.onkeydown = function (e) {
                    if ("Escape" === e.key) this.blur(), e.preventDefault();
                    else if ("Enter" === e.key) {
                        let t = Array.from(this.parentElement.children).findIndex((e) => e.classList.contains("pz-active"));
                        this.pz_input.pz_set(t), this.blur(), e.preventDefault();
                        ...
                        if (!i) return;
                        n.classList.remove("pz-active"), i.classList.add("pz-active"), t.pz_scrollTo(s), e.preventDefault();
                    }
                }),
            ...
            for (var i = 0; i < PZ.tween.easingList.length; i++) {
                ...
                (n.innerText = PZ.tween.easingList[i].name),
                    ...
                    (e.onmouseenter = function () {
                        Array.from(this.parentElement.children).forEach((e) => e.classList.remove("pz-active")), this.classList.add("pz-active");
                    }),
                    (e.onclick = function () {
                        let e = Array.prototype.indexOf.call(this.parentElement.children, this);
                        this.parentElement.pz_input.pz_set(e), this.parentElement.blur();
                    }),
                    t.appendChild(e);
            }
            t.onblur = function () {
    ...
    (PZ.ui.controls.keyframeToggleClick = function () {
        ...
        i.editor.history.startOperation(), i.propertyOps.toggleKeyframe(t, s), i.editor.history.finishOperation();
    }),
    (PZ.ui.controls.createKeyframeControls = function (e) {
        ...
        (s.style = "width:35px;height:23px;pointer-events:none"), i.appendChild(s);
        ...
        (r.style = "width:35px;height:23px;pointer-events:none"),
            ...
            (i.pz_set = function (e) {
                ...
                if ((r.editor.history.startOperation(), s instanceof PZ.property.dynamic.group))
                    for (let e = 0; e < s.objects.length; e++) s.objects[e].hasKeyframe(a) && r.propertyOps.setTween({ property: s.objects[e].getAddress(), frame: a, tween: (i.pz_value << 8) | n.pz_value });
                else r.propertyOps.setTween({ property: s.getAddress(), frame: a, tween: (i.pz_value << 8) | n.pz_value });
        ...
        a.classList.add("actionbutton"), (a.style = "margin-top:3px;margin-right:5px;vertical-align:top;"), (a.title = "previous keyframe"), (a.onclick = PZ.ui.controls.previousKeyframeClick);
        let o = PZ.ui.generateIcon("prevkf");
        (o.style = "width:17px;height:17px;fill:#ccc;stroke-width:10px;pointer-events:none"), a.appendChild(o);
        let l = document.createElement("button");
        l.classList.add("actionbutton"), (l.style = "margin-top:3px;margin-right:5px;vertical-align:top;"), (l.title = "add keyframe"), (l.onclick = PZ.ui.controls.keyframeToggleClick);
        let h = PZ.ui.generateIcon("keyframe");
        (h.style = "width:17px;height:17px;fill:none;stroke-width:10px;stroke:#ccc;pointer-events:none"), l.appendChild(h);
        let c = document.createElement("button");
        c.classList.add("actionbutton"), (c.style = "margin-top:3px;margin-right:5px;vertical-align:top;"), (c.title = "next keyframe"), (c.onclick = PZ.ui.controls.nextKeyframeClick);
        let p = PZ.ui.generateIcon("nextkf");
        return (
            (p.style = "width:17px;height:17px;fill:#ccc;stroke-width:10px;pointer-events:none"),
            c.appendChild(p),
            t.appendChild(a),
            t.appendChild(l),
            t.appendChild(c),
            ...
            (t.pz_update = function (e) {
                ...
                if (t instanceof PZ.property.dynamic.group)
                    ...
                    i && ((s = "#ccc"), (r = "delete keyframe"), (a = i.tween), (o = t.definition.interpolated));
                }
                (this.children[1].title = r), (this.children[1].children[0].style.fill = s), i.pz_update(a, o), n.pz_update(a, o);
            }),
            t
        );
    }),
    (PZ.ui.controls.createExpressionControls = function (e) {
        ...
        i.setAttribute("wrap", "off"), i.setAttribute("spellcheck", "false"), (i.style = "width: 240px; height: 40px;"), i.classList.add("pz-inputbox"), t.appendChild(i);
        let s = document.createElement("div");
        t.appendChild(s);
        let n = document.createElement("button");
        n.classList.add("actionbutton"), (n.title = "open expression editor");
        let r = PZ.ui.generateIcon("code");
        (r.style = "fill:#ccc;width:17px;height:17px;"),
            n.appendChild(r),
            (n.onclick = () => {
                let i = t.parentElement.parentElement.parentElement.pz_controls.editor.createWindow({ title: "Expression" }),
                    s = new PZ.ui.expression(i.editor, { property: e });
                i.setPanel(s), s.create();
            }),
            s.appendChild(n);
        let a = document.createElement("button");
        a.classList.add("actionbutton"), (a.style.display = "none"), (a.title = "show error");
    ...
    (PZ.ui.controls.stopwatchClick = function (e) {
        let t = this.parentElement.parentElement.pz_object,
            ...
            s = i.editor.playback.currentFrame - t.frameOffset;
        i.editor.history.startOperation(), i.propertyOps.toggleAnimation(t, s, e.altKey), i.editor.history.finishOperation();
    }),
    (PZ.ui.controls.createControls = function (e, t, i) {
        ...
        if (t instanceof PZ.property.dynamic) {
            ...
            a.classList.add("actionbutton"), (a.style = "margin-right: 5px; vertical-align: bottom;"), (a.title = "toggle animation");
            var o = PZ.ui.generateIcon("stopwatch");
            if (((o.style = "fill:#2a2a2a;width:17px;height:17px;"), a.appendChild(o), (a.onclick = PZ.ui.controls.stopwatchClick), t.animated)) {
                let e = (40 * PZ.stringHash(t.definition.name || "")) % 360;
                o.style.fill = `hsl(${e}, 60%, 45%)`;
            }
            n.insertBefore(a, n.getElementsByTagName("span")[0]), (t.hideAnimateToggle || i) && (a.style.display = "none");
        }
        ...
        if (Array.isArray(s)) for (let e = 0; e < s.length; e++) r.appendChild(s[e]);
    ...
    (PZ.ui.controls.valueChanged = function () {
        ...
        t.editor.history.startOperation(), t.propertyOps.toggleAnimation(e), t.editor.history.finishOperation();
    }),
    (PZ.ui.controls.editStart = function (e, t) {
        ...
        if (((i.pz_frame = n), (i.pz_oldValue = JSON.parse(JSON.stringify(e.get(n)))), e.definition.linkRatio && !t)) {
        ...
        if (e instanceof PZ.property.dynamic.group) for (let t = 0; t < e.objects.length; t++) s.propertyOps.startEdit(e.objects[t], n);
        else s.propertyOps.startEdit(e, n);
    }),
    (PZ.ui.controls.editFinish = function (e, t) {
        let i = this.parentElement,
            ...
            n = i.pz_frame,
            r = i.pz_oldValue;
        delete i.pz_frame, delete i.pz_oldValue, delete i.pz_normalized, s.propertyOps.setValue({ property: e.getAddress(), frame: n, oldValue: r }), t ? s.editor.history.discardOperation() : s.editor.history.finishOperation();
    }),
    (PZ.ui.controls.generateInputSpace = function (e) {
        let t = document.createElement("span");
        return (t.innerText = e.definition.spaceChar || ","), (t.style.color = "#999"), t;
    }),
    (PZ.ui.controls.generateInput = function (e) {
        ...
        let i = e.definition.readOnly || (e.animated && e.expression) || (e instanceof PZ.property.dynamic && !e.animated && e.keyframes.length > 1),
            s = { min: e.definition.min, max: e.definition.max, step: e.definition.step, decimals: e.definition.decimals, readOnly: i },
            n = new PZ.ui.input(s);
        t.appendChild(n.el), (n.editStart = PZ.ui.controls.editStart.bind(n.el, e)), (n.editFinish = PZ.ui.controls.editFinish.bind(n.el, e));
        return (
            (n.changed = function () {
    ...
    (PZ.ui.controls.generateInput2 = function (e) {
        let t = document.createElement("div");
        t.classList.add("editbox");
        let i = { min: e.definition.min, max: e.definition.max, step: e.definition.step, decimals: e.definition.decimals, readOnly: e.definition.readOnly || (e.animated && e.expression) },
            s = new PZ.ui.input(i),
            n = new PZ.ui.input(i);
        t.appendChild(s.el),
        ...
        let r = function (i, r, a) {
            ...
            let o = t.pz_frame;
            t.pz_normalized && (s.set(i * t.pz_normalized[0]), n.set(i * t.pz_normalized[1]));
            let l = e.definition.scaleFactor || 1;
            ((i = new Array(2))[0] = s.value * l), (i[1] = n.value * l), e.set(i, o);
        };
        return (
            (s.changed = r),
            (n.changed = r),
    ...
    (PZ.ui.controls.generateInput3 = function (e) {
        ...
        let a = function (i) {
            t.parentElement.parentElement.parentElement.pz_controls;
            let a = t.pz_frame;
            t.pz_normalized && (s.set(i * t.pz_normalized[0]), n.set(i * t.pz_normalized[1]), r.set(i * t.pz_normalized[2]));
            let o = e.definition.scaleFactor || 1;
            ((i = new Array(3))[0] = s.value * o), (i[1] = n.value * o), (i[2] = r.value * o), e.set(i, a);
        };
        return (
            (s.changed = a),
            (n.changed = a),
            ...
            (t.pz_update = function (t) {
                let i = e.definition.scaleFactor || 1,
                    a = e.get(t);
                s.update(a[0] / i), n.update(a[1] / i), r.update(a[2] / i);
            }),
            t
        );
    }),
    (PZ.ui.controls.generateInput4 = function (e) {
        ...
        let o = function (i) {
            t.parentElement.parentElement.parentElement.pz_controls;
            let o = t.pz_frame;
            t.pz_normalized && (s.set(i * t.pz_normalized[0]), n.set(i * t.pz_normalized[1]), r.set(i * t.pz_normalized[2]), a.set(i * t.pz_normalized[3]));
            let l = e.definition.scaleFactor || 1;
            ((i = new Array(4))[0] = s.value * l), (i[1] = n.value * l), (i[2] = r.value * l), (i[3] = a.value * l), e.set(i, o);
        };
        return (
            (s.changed = o),
            (n.changed = o),
            ...
            (t.pz_update = function (t) {
                let i = e.definition.scaleFactor || 1,
                    o = e.get(t);
                s.update(o[0] / i), n.update(o[1] / i), r.update(o[2] / i), a.update(o[3] / i);
            }),
            t
        );
    }),
    (PZ.ui.controls.generateTextInput = function (e) {
        ...
        return (
            ...
            (t.pz_update = function (t) {
                ...
                document.activeElement !== i && ((i.style.visibility = null === s ? "hidden" : "visible"), (i.value = s));
            }),
            t
        );
    }),
    (PZ.ui.controls.generateColorInput = function (e) {
        let t = document.createElement("div");
        t.classList.add("editbox"), (t.style = "line-height:0");
        let i = { readOnly: e.definition.readOnly || (e.animated && e.expression) },
            s = new PZ.ui.colorPicker(i);
        (s.el.style.verticalAlign = "middle"), t.appendChild(s.el), (s.editStart = PZ.ui.controls.editStart.bind(s.el, e)), (s.editFinish = PZ.ui.controls.editFinish.bind(s.el, e));
        if (
            ((s.changed = function () {
                t.parentElement.parentElement.parentElement.pz_controls;
                let i = t.pz_frame;
                ...
                (i.onclick = function () {
                    (document.body.style.cursor = "crosshair"),
                        document.addEventListener(
                            "click",
                            (s) => {
                                if (((document.body.style.cursor = ""), "CANVAS" === s.target.tagName)) {
                                    let n = s.target.parentElement.pz_panel;
                                    if (!n || !n.renderer) return;
                                    let r = n.pickColor(s.layerX, s.layerY);
                                    PZ.ui.controls.editStart.call(i, e), e.set(r, t.pz_frame), PZ.ui.controls.editFinish.call(i, e);
                                }
            ...
            (s.style = "width: 17px; height:17px; fill: #ccc;"), i.appendChild(s), t.appendChild(i);
        }
        return t;
    }),
    (PZ.ui.controls.generateOptionInput = function (e) {
        ...
        i.classList.add("pz-inputbox"),
            ...
            (i.onchange = function () {
                ...
                let s = t.pz_frame;
                e.set(i.selectedIndex, s), PZ.ui.controls.editFinish.call(this, e);
            });
        var s = e.definition.items;
        "string" == typeof s && (s = s.split(";"));
        for (var n = 0; n < s.length; ++n) {
            let e = document.createElement("option");
            (e.innerText = s[n]), i.appendChild(e);
        }
        return (
            t.appendChild(i),
            (t.pz_update = function (t) {
    ...
    (PZ.ui.controls.generateGradientInput = function (e) {
        ...
        t.appendChild(i.el), (i.editStart = PZ.ui.controls.editStart.bind(i.el, e)), (i.editFinish = PZ.ui.controls.editFinish.bind(i.el, e));
        return (
            (i.changed = function () {
                e.set(i.value);
            }),
    ...
    (PZ.ui.controls.generateFontInput = function (e) {
        ...
        t.classList.add("editbox");
        let i = document.createElement("button");
        i.classList.add("pz-tweens"), (i.title = "font"), (i.style = "height:auto"), (i.onclick = () => PZ.editor.showFontDropDown(i)), (i.pz_value = 0);
        ...
        (s.style = "display:block; width:200px; height:25px; margin:1px; background-image:url('fonts.png')"),
            ...
            (i.pz_set = function (t) {
                ...
                PZ.ui.controls.editStart.call(this, e), e.set(i), PZ.ui.controls.editFinish.call(this, e);
            }),
        ...
        return (
            ...
            (t.pz_update = function () {
                ...
                } else (n.style.display = ""), n.pz_update();
                (i.pz_value = s), i.pz_update();
            }),
            [t, n]
        );
    }),
    (PZ.ui.controls.generateTextureInput = function (e) {
        ...
        i.classList.add("pz-inputbox"),
            (i.onchange = function () {
                ...
                PZ.ui.controls.editStart.call(this, e), e.set(s), PZ.ui.controls.editFinish.call(this, e);
            });
        ...
        (r.innerText = "custom"), i.appendChild(r), t.appendChild(i);
        ...
        return (
            ...
            (t.pz_update = function () {
                ...
                } else (a.style.display = ""), a.pz_update();
                i.selectedIndex = s;
            }),
            [t, a]
        );
    ...
    (PZ.ui.controls.generateListInput = function (e) {
        ...
        i.classList.add("pz-inputbox"),
            (i.onchange = function () {
                ...
                e.set(n, s), PZ.ui.controls.editFinish.call(this, e);
            });
        for (var s = e.definition.items, n = 0; n < s.length; n++) {
            let e = document.createElement("option");
            (e.innerText = s[n].name), (e.pz_value = s[n].value), i.appendChild(e);
        }
        return (
            t.appendChild(i),
            (t.pz_update = function (t) {
        ...
        i.setAttribute("type", "file"),
            ...
            (i.onchange = async function () {
                if (i.files && i.files[0]) {
                    ...
                    PZ.ui.controls.editStart.call(this, e), e.set(s.key), PZ.ui.controls.editFinish.call(this, e);
                }
            });
        let s = document.createElement("button");
        s.classList.add("actionbutton"), (s.title = "choose file...");
        let n = PZ.ui.generateIcon("load");
        (n.style = "fill:#ccc;width:17px;height:17px;"), s.appendChild(n), (s.onclick = () => i.click());
        let r = document.createElement("button");
        r.classList.add("actionbutton"), (r.title = "delete");
        let a = PZ.ui.generateIcon("remove");
        (a.style = "fill:#ccc;width:17px;height:17px;"),
            r.appendChild(a),
            (r.onclick = () => {
                PZ.ui.controls.editStart.call(i, e), e.set(null), PZ.ui.controls.editFinish.call(i, e);
            });
        let o = document.createElement("span");
        return (
            (o.style = "color: #999;"),
            e.definition.readOnly || ((o.style.verticalAlign = "middle"), (t.style.lineHeight = "0"), t.appendChild(i), t.appendChild(s), t.appendChild(r)),
            t.appendChild(o),
            (t.pz_update = function () {
                let t = e.get();
                if (null === t) (r.style.display = "none"), (o.innerText = "(none)"), (o.title = "");
                else {
                    r.style.display = "";
                    let i = e.parentProject.assets.list[t],
                        s = (e, t) => (e.length > t ? e.substr(0, t - 3) + "..." : e),
                        n = i.filename || i.key;
                    (o.innerText = s(n, 20)), (o.title = n);
                }
            }),
            t
        );
    ...
    (PZ.ui.controls.generateShaderInput = function (e) {
        ...
        t.classList.add("editbox");
        let i = document.createElement("button");
        i.classList.add("actionbutton"), (i.title = "open expression editor");
        let s = PZ.ui.generateIcon("code");
        return (
            (s.style = "fill:#ccc;width:17px;height:17px;"),
            i.appendChild(s),
            (i.onclick = () => {
                let i = t.parentElement.parentElement.parentElement.pz_controls.editor.createWindow({ title: "Shader" }),
                    s = new PZ.ui.shader(i.editor, { property: e });
                i.setPanel(s), s.create();
            }),
            t.appendChild(i),
            (t.pz_update = function () {}),
    ...
    (PZ.ui.controls.legacy = {
        generateSpacer() {
            let e = document.createElement("div");
            return e.classList.add("proprow", "spacer"), e;
        },
        generateTitle(e) {
            let t = document.createElement("div");
            t.classList.add("proprow", "proptitle", "noselect"), (t.style = "text-overflow: ellipsis;overflow: hidden;white-space: nowrap;padding-right: 5px;");
            let i = document.createElement("span");
            return i.classList.add("proplabel"), (i.innerText = e.title), (i.title = e.title), (i.style = "font-size:18px;font-weight:bold;"), t.appendChild(i), t;
        },
        ...
        generateValue(e, t) {
            let i = document.createElement("div");
            i.classList.add("proprow", "noselect"), (i.style = "background-color:rgb(45, 45, 45)");
            let s = document.createElement("span");
            (s.innerText = e.title), i.appendChild(s);
            let n = document.createElement("span");
            return (
        ...
        generateButton(e, t) {
            let i = document.createElement("button");
            i.classList.add("proprow", "propbutton", "noselect"), (i.onclick = e.clickfn.bind(t));
            let s = document.createElement("span");
            return (s.innerText = e.title), i.appendChild(s), i;
        },
    ...
    (PZ.ui.viewport.prototype.objectsChanged = function () {
        ...
        1 === t.length && (e = t[0].object),
            e ? ((this.layer = e), (this.scene = e.threeObj), this.scene.add(this.threeObj)) : this.layer && ((this.layer = null), this.scene.remove(this.threeObj), (this.scene = null)),
            (this.edit = this.edit);
    }),
    ...
    (PZ.ui.viewport.prototype.keydown = function (e) {
        "c" === e.key && (e.stopPropagation(), (this.edit = !this.edit));
    }),
    (PZ.ui.viewport.prototype.resize = function () {
        ...
        let e = this.sequence.properties.resolution.get(),
            ...
            r = Math.round(t * n),
            a = Math.round(i * n);
        (this.canvas.style.width = r + "px"), (this.canvas.style.height = a + "px"), (this.canvas.style.left = 0.5 * (s.width - r) + "px"), (this.canvas.style.top = 0.5 * (s.height - a) + "px");
    ...
    (PZ.ui.viewport.prototype.render = function () {
        ...
        let e = this.editor.playback.currentFrame;
        this.widget2d.update(e), this.widget3d.update(e), this._render();
    }),
    (PZ.ui.viewport.prototype._render = function () {
        let e = this.editor.playback.currentFrame;
        this.renderMode ? (this.layer.update(e - this.layer.parent.start), this.renderer.render(this.scene, this.camera), (this.lastFrame = -1)) : (this.compositor.renderSequence(e), (this.lastFrame = e));
    }),
    (PZ.ui.viewport.prototype.pickColor = function (e, t) {
        let i = this.renderer.context,
            s = new Uint8Array(4);
        return (
            (e = Math.round((e / parseFloat(this.canvas.style.width)) * i.drawingBufferWidth)),
    ...
    (PZ.ui.drag.prototype.convertTouchEvent = function (e) {
        let t = { ctrlKey: e.ctrlKey, shiftKey: e.shiftKey, altKey: e.altKey, metaKey: e.metaKey, target: e.target, currentTarget: e.currentTarget, stopPropagation: () => e.stopPropagation(), preventDefault: () => e.preventDefault() },
            i = e.touches[0];
        return i && ((t.screenX = i.screenX), (t.screenY = i.screenY), (t.clientX = i.clientX), (t.clientY = i.clientY), (t.pageX = i.pageX), (t.pageY = i.pageY)), t;
    }),
    ...
    (PZ.ui.drag.prototype.movefn = function (e, t) {
        t.preventDefault(), this.move.call(e, t);
    }),
    ...
    (PZ.ui.drag.prototype.stopDragging = function (e, t) {
        ...
        this.movefn_bound && (i.removeEventListener("mousemove", this.movefn_bound), i.removeEventListener("touchmove", this.movefn_bound), (this.movefn_bound = null)),
            this.reqId && (cancelAnimationFrame(this.reqId), (this.updatefn_bound = null)),
    ...
    (PZ.ui.input.prototype.keydown = function (e) {
        if ("Enter" === e.key) this.el.blur();
        else if ("Escape" === e.key) (this.el.innerText = ""), this.el.blur();
    ...
    (PZ.ui.input.prototype.drag = function (e) {
        (this.currentPt.x = e.pageX - this.origin.x), (this.currentPt.y = e.pageY - this.origin.y), (this.shiftKey = e.shiftKey), (this.ctrlKey = e.ctrlKey);
    }),
    ...
    (PZ.ui.input.prototype.setValue = function (e) {
        let t = this.value;
        this.set(e), this.changed && this.changed(e, t);
    }),
    ...
    (PZ.ui.colorPicker.prototype.hsvToRgb = function (e, t, i) {
        let s, n, r, a, o, l, h, c;
        switch (((l = i * (1 - t)), (h = i * (1 - (o = 6 * e - (a = Math.floor(6 * e))) * t)), (c = i * (1 - (1 - o) * t)), a % 6)) {
            case 0:
                (s = i), (n = c), (r = l);
                break;
            case 1:
    ...
    (PZ.ui.colorPicker.prototype.colorToStyle = function (e) {
        return 4 === e.length
            ? "rgba(" + Math.floor(255 * e[0]) + ", " + Math.floor(255 * e[1]) + ", " + Math.floor(255 * e[2]) + ", " + e[3].toFixed(3) + ")"
            : "rgb(" + Math.floor(255 * e[0]) + ", " + Math.floor(255 * e[1]) + ", " + Math.floor(255 * e[2]) + ")";
    }),
    (PZ.ui.colorPicker.prototype.styleToColor = function (e) {
        let t = e
            ...
            .split(",")
            .map((e) => parseFloat(e));
        return (t[0] /= 255), (t[1] /= 255), (t[2] /= 255), (t[3] = t[3] || 1), (t = t.slice(0, this.alpha ? 4 : 3));
    }),
    ...
    (PZ.ui.colorPicker.prototype.open = function () {
        (this.picker = document.createElement("div")),
            ...
            this.picker.addEventListener("keydown", (e) => {
                if ("Escape" === e.key || "Enter" === e.key) return this.close("Escape" === e.key), void e.preventDefault();
                this.el.dispatchEvent(new KeyboardEvent(e.type, e));
            });
        let e = document.createElement("div");
        (e.style = "width: 250px; height: 250px; position: absolute; left: 5px; top: 5px;"), (e.pz_value = [0, 0]);
        let t = document.createElement("div");
        ...
        if (
            ((n.style = "position: absolute; width: 100%; height: 6px; margin-top: -3px; box-sizing: border-box; border: 1px solid #aaa;"),
            i.appendChild(n),
            ...
            (e.style = "position: absolute; width: 100%; height: 6px; margin-bottom: -3px; box-sizing: border-box; border: 1px solid #aaa;"),
                ...
                (s.pz_update = (t) => {
                    ...
                    (s.style.background = "linear-gradient(to bottom, " + i + ", 1) 0%, " + i + ", 0) 100%)"), (e.style.bottom = 100 * t[3] + "%");
                }),
        ...
        (a.style = "position: absolute; left: 0; right: 50%; height: 25px;"),
            ...
            (a.onclick = (e) => {
                this.setValue(this.initialValue.slice()), this.picker.pz_update(this.value);
            }),
            r.appendChild(a);
        let o = document.createElement("div");
        (o.style = "position: absolute; left: 50%; right: 0; height: 25px;"), r.appendChild(o);
        ...
        let h = (e) => {
            ...
            this.alpha ? ((t.length = 4), (t[3] = t[3] || 1)) : (t.length = 3), this.setValue(t), this.picker.pz_update(this.value);
        };
        for (let e = PZ.ui.colorPicker.recentColors.length - 1; e >= 0; e--) {
            ...
            (s.style.backgroundColor = this.colorToStyle(i)), (s.onclick = h), (s.pz_color = i), l.appendChild(s);
        }
        r.appendChild(l);
        let c = document.createElement("input");
        c.classList.add("pz-inputbox"),
            ...
            (c.onkeydown = (e) => {
                "Enter" === e.key && this.picker.focus(), e.stopPropagation();
            }),
            (c.onblur = (e) => {
                let t = document.createElement("div");
                t.style.color = e.currentTarget.value;
                let i = t.style.color;
                i && this.setValue(this.styleToColor(i)), this.picker.pz_update(this.value);
            }),
            (c.pz_update = (e) => {
            ...
            (this.picker.pz_update = (t) => {
                let n;
                t
                    ? ((n = this.rgbToHsv(t)), (i.pz_value = Math.min(Math.max(n[0], 0), 1)), (e.pz_value[0] = Math.min(Math.max(n[1], 0), 1)), (e.pz_value[1] = Math.min(Math.max(n[2], 0), 1)), this.alpha && (s.pz_value = t[3]))
            ...
            (this.picker.pz_set = () => {
                ...
                (this.value[0] = t[0]), (this.value[1] = t[1]), (this.value[2] = t[2]), this.alpha && (this.value[3] = s.pz_value), this.setValue(this.value), this.picker.pz_update();
            }),
    ...
    (PZ.ui.colorPicker.prototype.dragStart = function (e) {
        (this.control = e.currentTarget), (this.origin = this.control.getBoundingClientRect()), (this.currentPt = { x: 0, y: 0 }), (this.elPt = { x: 0, y: 0 }), this.ctx.picker.focus();
    }),
    (PZ.ui.colorPicker.prototype.drag = function (e) {
        (this.currentPt.x = e.pageX), (this.currentPt.y = e.pageY), (this.shiftKey = e.shiftKey), (this.ctrlKey = e.ctrlKey);
    }),
    (PZ.ui.colorPicker.prototype.dragUpdate = function () {
        (this.elPt.x = Math.min(Math.max((this.currentPt.x - this.origin.left) / this.origin.width, 0), 1)), (this.elPt.y = Math.min(Math.max((this.currentPt.y - this.origin.top) / this.origin.height, 0), 1));
    }),
    (PZ.ui.colorPicker.prototype.slDragUpdate = function () {
        this.ctx.dragUpdate.call(this), (this.control.pz_value[0] = this.elPt.x), (this.control.pz_value[1] = 1 - this.elPt.y), this.ctx.picker.pz_set();
    }),
    (PZ.ui.colorPicker.prototype.hDragUpdate = function () {
        this.ctx.dragUpdate.call(this), (this.control.pz_value = this.elPt.y), this.ctx.picker.pz_set();
    }),
    (PZ.ui.colorPicker.prototype.aDragUpdate = function () {
        this.ctx.dragUpdate.call(this), (this.control.pz_value = 1 - this.elPt.y), this.ctx.picker.pz_set();
    }),
    (PZ.ui.colorPicker.prototype.update = function (e, t) {
        (this.editing && !t) || ((this.value = e), (this.el.style.backgroundColor = this.colorToStyle(e)));
    }),
...
(PZ.ui.gradientPicker = class {
    constructor(e) {
        (this.el = document.createElement("div")), (this.el.style = "padding: 5px; width: 245px; box-sizing: border-box; margin: 0;");
        let t = document.createElement("button");
        t.classList.add("pz-inputbox", "noselect"), (t.style = "width: 100%; height:30px; display: block;"), this.el.appendChild(t);
        let i = document.createElement("div");
        (i.style = "width: 100%; height: 15px; margin-top: 5px; position: relative;"),
            ...
            (t.pz_update = (e) => {
                let i;
                if (1 === e.length) i = e[0].color;
                else {
                    i = "linear-gradient(to right, ";
                    for (let t = 0; t < e.length; t++) t > 0 && (i += ", "), (i += e[t].color), (i += " "), (i += 100 * e[t].position), (i += "%");
                    i += ")";
                }
    ...
    click(e) {
        ...
        let i,
            s = 0;
        for (; s < this.value.length && this.value[s].position < t; ) s++;
        if (1 === this.value.length) i = this.value[0].color;
        else if (0 === s) i = this.value[0].color;
        else if (s === this.value.length) i = this.value[this.value.length - 1].color;
        else {
            ...
            i = "rgba(";
            for (let e = 0; e < 4; e++) e > 0 && (i += ", "), (i += n[e] + o * (a[e] - n[e]));
            i += ")";
        }
        let n = { position: t, color: i };
        this.editStart.call(this.el), this.value.splice(s, 0, n), this.changed && this.changed(this.value), this.editFinish.call(this.el), this.update(this.value);
    }
    ptContextMenu(e) {
        if ((e.preventDefault(), this.value.length <= 1)) return;
        let t = e.currentTarget;
        t.focus(), this.editStart.call(this.el);
        let i = Array.prototype.indexOf.call(t.parentElement.children, t);
        this.value.splice(i, 1), this.changed && this.changed(this.value), this.editFinish.call(this.el), this.update(this.value);
    }
    ptKeydown(e) {
        if ("Delete" === e.key || "Backspace" === e.key) this.ptContextMenu(e);
        else if ("ArrowUp" === e.key || "ArrowDown" === e.key) {
            let t = e.currentTarget,
                i = "ArrowDown" === e.key ? t.nextElementSibling : t.previousElementSibling;
            i && (t.setAttribute("tabindex", "-1"), i.removeAttribute("tabindex"), i.focus()), e.preventDefault(), e.stopPropagation();
        } else ("ArrowLeft" !== e.key && "ArrowRight" !== e.key) || (e.preventDefault(), e.stopPropagation());
    }
    ptDragStart(e) {
    ...
    (PZ.ui.history = function (e) {
        (this.editor = e), e.onProjectChanged.watch(this.projectChanged.bind(this));
    }),
    (PZ.ui.history.command = function (e, t) {
        (this.fn = e), (this.params = t);
    }),
    ...
    (PZ.ui.history.prototype.pushSingleCommand = function (e, t) {
        null === this.operation ? (this.startOperation(), this.pushCommand(e, t), this.finishOperation()) : this.pushCommand(e, t);
    }),
    (PZ.ui.history.prototype.discardOperation = function () {
        for (let e = this.operation.length - 1; e >= 0; e--) this.operation[e].execute();
        this.operation = null;
    }),
        ...
        (this.editor = e),
            ...
            Object.defineProperties(this, {
                enabled: {
                    ...
                    set(e) {
                        this._enabled !== e && ((this._enabled = e), e ? (this.animFrameReq = requestAnimationFrame(this._updateFn)) : cancelAnimationFrame(this.animFrameReq));
                    },
                },
                currentTime: {
                    get() {
                ...
                currentFrame: {
                    ...
                    set(e) {
                        (this._exactFrame = e), (this._currentFrame = Math.round(e));
                    },
                },
            }),
            (this._updateFn = this.update.bind(this)),
    ...
    (PZ.ui.playback.prototype.sequenceChanged = function () {
        if (((this._sequence = this.editor.sequence), (this.speed = 0), (this.currentFrame = 0), this._sequence)) {
            for (let e = 0; e < this._sequence.audioSchedules.length; e++) this.scheduleCreated(this._sequence.audioSchedules[e]);
            this._sequence.ui.onScheduleCreated.watch(this.scheduleCreated.bind(this)), this._sequence.ui.onScheduleUnloaded.watch(this.scheduleUnloaded.bind(this));
        }
    }),
    ...
    (PZ.ui.playback.prototype.scheduleUnloaded = function (e) {
        this.syncSchedule === e && (this.syncSchedule = null),
            e.sourceNode && (e.sourceNode.disconnect(), e.gainNode.disconnect(), e.panNode.disconnect()),
        ...
        if (e.currentItem) {
            if ((e.texture && e.el.readyState === e.el.HAVE_ENOUGH_DATA && (e.texture.needsUpdate = true), e.el)) {
                ...
                if (t > 0) {
                    if (e.sourceNode) {
                        let t;
                        (t = e.currentItem.clip.object.properties.volume.get(s)), (e.gainNode.gain.value = t), (t = e.currentItem.clip.object.properties.pan.get(s)), (e.panNode.pan.value = t);
                    }
                    if (e.playing) {
    ...
    (PZ.ui.playback.prototype.update = function (e) {
        ...
        if (((this.lastFrame = e), this.syncSchedule && this.syncSchedule.currentItem && !this.syncSchedule.currentItem.clip.properties.time.animated)) {
        ...
        if (this._exactFrame >= this.totalFrames || this._exactFrame < 0)
            ...
            } else (this._exactFrame = Math.max(Math.min(this._exactFrame, this.totalFrames - 1), 0)), (this.speed = 0);
        (this._currentFrame = Math.round(this._exactFrame)), this._sequence.update(this.currentFrame);
        for (var i = 0; i < this._sequence.audioSchedules.length; i++) this._sequence.audioSchedules[i].update(this.currentFrame, this.frameRate), this.updateSchedule(this._sequence.audioSchedules[i], t);
        for (i = 0; i < this._sequence.videoSchedules.length; i++) this._sequence.videoSchedules[i].update(this.currentFrame, this.frameRate), this.updateSchedule(this._sequence.videoSchedules[i], t);
    }),
    (PZ.ui.properties = function (e) {
        this.editor = e;
    }),
    (PZ.ui.properties.prototype.resetAll = function (e) {
        for (let t of e) this.reset(t);
    }),
    (PZ.ui.properties.prototype.reset = function (e) {
        if (e instanceof PZ.property.dynamic.group) {
            for (let t = 0; t < e.objects.length; t++) this.reset(e.objects[t]);
            return;
        }
        let t = e.getAddress();
    ...
    (PZ.ui.properties.prototype.toggleAnimation = function (e, t, i, s) {
        ...
        if (s) {
            if (i) {
                ...
                let i = { property: n, oldFrame: e.keyframes[0].frame, newFrame: t };
                this.moveKeyframe(i);
            }
        } else {
            let i, s, r, a;
            if ((e.definition.staticBehavior === PZ.property.dynamic.staticBehavior.LINEAR ? ((a = e.getParentOfType(PZ.clip).length), (s = e.get(0)), (r = e.get(a))) : (i = e.get(t)), e.expression)) {
            ...
            if (e.keyframes) {
                ...
                if (e.definition.staticBehavior === PZ.property.dynamic.staticBehavior.LINEAR) {
                    let e;
                    (e = { property: n, data: new PZ.keyframe(s, 0) }), this.createKeyframe(e), (e = { property: n, data: new PZ.keyframe(r, a) }), this.createKeyframe(e);
                } else {
                    let t;
                    (t = { property: n, data: new PZ.keyframe(i, 0, e.defaultTween) }), this.createKeyframe(t);
                }
            }
        }
    ...
    (PZ.ui.properties.prototype.toggleKeyframe = function (e, t, i) {
        ...
        if (e instanceof PZ.property.dynamic.group) for (let s = 0; s < e.objects.length; s++) this.toggleKeyframe(e.objects[s], t, i);
            ...
            let i, s;
            if (((i = e.definition.allowEmpty ? e.definition.defaultValue(e, t) : e.get(t)), e.interpolated)) {
                let i = e.getClosestKeyframeIndex(t),
                    n = e.keyframes[i];
                n.frame < t && i < e.keyframes.length - 1 && (n = e.keyframes[i + 1]), (s = n.tween);
            } else s = 0;
            this.createKeyframe({ property: e.getAddress(), data: new PZ.keyframe(i, t, s) });
        } else {
            if (!e.definition.allowEmpty && e.keyframes.length <= 1) return;
    ...
    (PZ.ui.properties.prototype.startEdit = function (e, t) {
        if (e.animated) {
            ...
            if (s && s.frame !== t) {
                let n = e.get(t);
                s.frame < t && i < e.keyframes.length - 1 && (s = e.keyframes[i - 1]), this.createKeyframe({ property: e.getAddress(), data: new PZ.keyframe(n, t, s.tween) });
            }
        }
    }),
    (PZ.ui.properties.prototype.setAnimated = function (e) {
        (this.editor.project.addressLookup(e.property).animated = e.animated), this.editor.history.pushCommand(PZ.ui.properties.prototype.setAnimated.bind(this), { property: e.property, animated: !e.animated });
    }),
    ...
    (PZ.ui.properties.prototype.setTween = function (e) {
        let t = this.editor.project.addressLookup(e.property),
            i = t.getKeyframe(e.frame),
            s = i.tween;
        (i.tween = e.tween), this.editor.history.pushCommand(PZ.ui.properties.prototype.setTween.bind(this), { property: e.property, frame: e.frame, tween: s }), t.onKeyframeChanged.update(i);
    }),
    (PZ.ui.properties.prototype.setContinuousTangent = function (e) {
        ...
        if (s !== e.continuous) {
            if (((i.continuousTangent = e.continuous), i.continuousTangent)) {
                let t = i.controlPoints[0].slice(),
                    s = i.controlPoints[1].slice(),
                    n = Math.sqrt(t[0] * t[0] + t[1] * t[1]),
                    r = Math.atan2(t[1], t[0]) + Math.PI;
                (s[0] = n * Math.cos(r)), (s[1] = n * Math.sin(r)), this.setControlPoints({ property: e.property, frame: e.frame, controlPoints: [t, s] });
            }
            this.editor.history.pushCommand(PZ.ui.properties.prototype.setContinuousTangent.bind(this), { property: e.property, frame: e.frame, continuous: s }), t.onKeyframeChanged.update(i);
        }
    }),
    (PZ.ui.properties.prototype.setExpression = function (e) {
        ...
        t.expression && (i = t.expression.source),
            ...
            this.editor.history.pushSingleCommand(PZ.ui.properties.prototype.setExpression.bind(this), { property: e.property, expression: i });
    }),
    (PZ.ui.properties.prototype.pasteKeyframes = function (e, t, i) {
        if (!t.length) return;
        let s = e.getAddress();
        for (let n = 0; n < t.length; n++) {
            (t[n].frame += i), e.getKeyframe(t[n].frame) && this.deleteKeyframe({ property: s, frame: t[n].frame }), this.createKeyframe({ property: s, data: t[n] });
        }
    }),
    (PZ.ui.properties.prototype.createKeyframe = function (e) {
        ...
        this.editor.history.pushCommand(PZ.ui.properties.prototype.deleteKeyframe.bind(this), { property: e.property, frame: e.data.frame }), t.onKeyframeCreated.update(i, s);
    }),
    (PZ.ui.properties.prototype.deleteKeyframe = function (e) {
        ...
        this.editor.history.pushCommand(PZ.ui.properties.prototype.createKeyframe.bind(this), s), t.onKeyframeDeleted.update(i);
    }),
    (PZ.ui.properties.prototype.moveKeyframe = function (e) {
        let t = this.editor.project.addressLookup(e.property),
            i = t.getKeyframeUnsorted(e.oldFrame);
        (i.frame = e.newFrame), this.editor.history.pushCommand(PZ.ui.properties.prototype.moveKeyframe.bind(this), { property: e.property, oldFrame: e.newFrame, newFrame: e.oldFrame }), t.sortKeyframes(), t.onKeyframeMoved.update(e, i);
    }),
    ...
    (PZ.ui.properties.prototype.finishMove = function (e, t, i, s) {
        ...
        for (let i = e.keyframes.length - 2; i >= 0; i--) {
            ...
            if (s.frame === n.frame) {
                ...
                this.editor.history.pushCommand(PZ.ui.properties.prototype.createKeyframe.bind(this), r), e.onKeyframeDeleted.update(n);
            }
        }
        for (let t = 0; t < i.length; t++) this.editor.history.pushCommand(PZ.ui.properties.prototype.moveKeyframe.bind(this), i[t]), e.onKeyframeMoved.update(i[t], s.get(i[t]));
    }),
    (PZ.ui.media = class extends PZ.ui.panel.nav {
        ...
        createMainPage() {
            ...
            new PZ.ui.media.search(this), new PZ.ui.media.list.missing(this);
        ...
        createMedia(e) {
            let t = new PZ.media();
            this.editor.project.media.splice(e.address[1], 0, t), (t.loading = t.load(e.data)), this.editor.history.pushCommand(PZ.ui.media.prototype.deleteMedia.bind(this), { address: e.address });
        }
        moveMedia(e) {
            this.editor.history.pushCommand(PZ.ui.media.prototype.moveMedia.bind(this), { oldAddress: e.newAddress, newAddress: e.oldAddress });
        }
        deleteMedia(e) {
            let t = this.editor.project.media[e.address[1]];
            t.unload(), this.editor.project.media.splice(e.address[1], 1), this.editor.history.pushCommand(PZ.ui.media.prototype.createMedia.bind(this), { address: e.address, data: JSON.parse(JSON.stringify(t)) });
        }
        async importCreation(e) {
            ...
            return (r.title = i.title), (r.thumbnail = PZ.blobOrigin + "/creation-thumbnails/" + e + ".jpg"), r;
        }
        async importFile(e) {
            let t;
            return e.type.startsWith("video") || e.type.startsWith("audio") ? (t = this.importAV(e)) : e.type.startsWith("image") ? (t = this.importImage(e)) : e.name.endsWith(".pz") && (t = this.importProject(e)), t;
        }
        async importProject(e) {
            ...
            return r.data.push(...i.sequence.videoTracks), r.data.push(...i.sequence.audioTracks), (r.properties.name = e.name), (r.properties.icon = "sequence"), r;
        }
        async importAV(e) {
            ...
            if (!i && !s) return null;
            let n = { properties: {}, data: [], baseType: "track", assets: [t.key] };
            if (i) {
                (n.thumbnail = i.thumbnail), delete i.thumbnail;
            ...
            return i && s && ((i.link = 0), (s.link = 0)), (n.properties.name = e.name), (n.properties.icon = "wave"), n;
        }
        async importImage(e) {
            let t = await this.editor.project.assets.createFromFile(PZ.asset.type.IMAGE, e);
            var i = await this.loadImage(t);
            if (!i) return null;
            var s = { properties: {}, data: [], baseType: "track", assets: [t.key] };
            (s.thumbnail = i.thumbnail), delete i.thumbnail;
            let n = { type: 0, clips: [i] };
            return s.data.push(n), (s.properties.name = e.name), (s.properties.icon = "sequence"), s;
        }
                    ...
                    async function n() {
                        ...
                        if (0 !== s && 0 !== n) {
                            ...
                            var r = Math.min(330 / s, 186 / n),
                                ...
                                o = { type: 0, start: 0, length: t, offset: 0, properties: { name: e.filename, media: e.key }, object: { type: 0, effects: [], properties: { resolution: [s, n] } }, thumbnail: a };
                            (this.onseeked = null), i(o);
                        } else i();
                    }
                    (t.onloadedmetadata = t.onloadeddata = function () {
                        (this.onseeked = n), (this.currentTime = 0.1 * this.duration), (this.onloadedmetadata = null), (this.onloadeddata = null);
                    }),
                        (t.preload = "metadata"),
                        (t.src = e.url);
                });
                ...
                (t.onload = async function () {
                    ...
                    if (0 !== t && 0 !== s) {
                        var n = Math.min(330 / t, 186 / s),
                            ...
                            a = { type: 0, start: 0, length: 150, offset: 0, properties: { name: e.filename }, object: { type: 3, effects: [], properties: { childProperties: { image: e.key }, resolution: [t, s] } }, thumbnail: r };
                        (this.onload = null), i(a);
                    } else i();
                }),
                    (t.src = e.url);
            });
            ...
            if ("no" !== (i = "" === i ? "no" : i))
                return new Promise(function (i, s) {
                    (t.onloadeddata = function () {
                        ...
                        e.length = this.duration;
                        var n = { type: 1, start: 0, length: s, offset: 0, properties: { name: e.filename, media: e.key } };
                        (this.onloadeddata = null), (t = null), i(n);
                    }),
                        (t.preload = "metadata"),
                        (t.src = e.url);
                });
    ...
    (PZ.ui.media.list.prototype.createItem = function (e) {
        ...
        let i = document.createElement("div");
        i.classList.add("media-item-img"), t.appendChild(i);
        let s = document.createElement("div");
        return s.classList.add("media-item-title"), (s.innerText = "Loading..."), t.appendChild(s), t;
    }),
    ...
    (PZ.ui.media.list.missing.prototype.locateFiles = async function (e) {
        let t = e.currentTarget.files;
        for (let e = 0; e < t.length; e++) await this.assets.locate(t[e]);
    }),
    (PZ.ui.media.list.missing.prototype.projectChanged = function () {
        this.media.editor.project ? ((this.assets = this.media.editor.project.assets), this.assets.onAssetCreated.watch(this.assetsChanged.bind(this)), this.assets.onAssetRemoved.watch(this.assetsChanged.bind(this))) : (this.assets = null),
            this.assetsChanged();
    }),
    (PZ.ui.media.list.missing.prototype.assetsChanged = function () {
        if (((this.el.innerHTML = ""), this.assets)) {
        ...
        (this.title.nameEl.innerText = "Missing assets (" + e + ")"), 0 === e ? ((this.title.el.style.display = "none"), (this.el.style.display = "none")) : ((this.title.el.style.display = ""), (this.el.style.display = ""));
    }),
    ...
    (PZ.ui.media.list.missing.prototype.createItem = function (e) {
        ...
        let i = t.children[0],
            s = t.children[1];
        return i.remove(), (t.title = e.title), (s.innerText = e.filename || e.sha256), t.classList.add("mediaitem"), t;
    }),
    (PZ.ui.media.list.community = function (e) {
        (this.title = new PZ.ui.media.title(e)), (this.title.nameEl.innerText = "Community media"), e.el.appendChild(this.title.el), PZ.ui.media.list.call(this, e), (this.searchQuery = ""), (this.searchTimeout = null), this.redrawList("");
    }),
    (PZ.ui.media.list.community.prototype.search = function (e) {
        clearTimeout(this.searchTimeout), (this.searchQuery = e), (this.el.innerHTML = ""), (this.searchTimeout = setTimeout(this.redrawList.bind(this, e), 1e3));
    }),
    (PZ.ui.media.list.community.prototype.createItem = function (e) {
        ...
        return (
            ...
            this.clickfn && ((t.style = "cursor:default;"), (t.onclick = this.clickfn)),
            t
        );
    }),
    ...
    (PZ.ui.media.list.community.prototype.redrawList = async function (e) {
        ...
        "" !== e && (t = "?pageSize=12&section=4&query=" + encodeURIComponent(e)), (this.el.innerHTML = "");
        let i = await this.loadCreationsList(t);
        if (i && i.length) this.createItems(i);
        else {
            let e = document.createElement("div");
            e.classList.add("empty", "noselect"), (e.innerText = i ? "no results" : "couldn't load media"), this.el.appendChild(e);
        }
    }),
    ...
    (PZ.ui.media.list.project.prototype.projectChanged = function () {
        ...
        e && (e.media.onObjectAdded.watch(this.mediaCreated.bind(this)), e.media.onObjectRemoved.watch(this.mediaDeleted.bind(this))), this.redrawList();
    }),
    ...
    (PZ.ui.media.list.project.prototype.importFiles = function (e) {
        ...
        for (let e = 0; e < t.length; e++) {
            let i = this.media.importFile(t[e]),
                s = { address: [1, this.editor.project.media.length], data: i };
    ...
    (PZ.ui.media.list.project.prototype.search = function (e) {
        if ("" === e) {
            for (let e = 0; e < this.el.children.length; e++) this.el.children[e].style.display = "";
            return;
        }
        for (let e = 0; e < this.el.children.length; e++) this.el.children[e].style.display = "none";
        let t = this.fuse.search(e);
        for (let e = 0; e < t.length; e++) t[e].el.style.display = "";
    }),
    (PZ.ui.media.list.project.prototype.createItem = function (e, t) {
        var i = PZ.ui.media.list.prototype.createItem.call(this);
        (i.onmousedown = this.mouseDown.bind(this)), (i.onmouseup = this.mouseUp.bind(this)), (i.ondragstart = this.dragStart.bind(this)), (i.ondragend = this.dragEnd.bind(this)), this.touchDrag.addElts(i);
        return (
            e.onLoaded.watch(function () {
                if (!e.loaded) return;
                let s = i.children[0];
                if (((i.children[1].innerText = e.properties.name.get()), (i.title = e.properties.name.get()), e.thumbnail)) {
                    var n = document.createElement("img");
                    (n.style.width = "100%"), (n.src = "string" == typeof e.thumbnail ? e.thumbnail : URL.createObjectURL(e.thumbnail)), delete e.thumbnail, s.appendChild(n);
                } else {
    ...
    (PZ.ui.media.list.project.prototype.drop = function (e) {
        e.preventDefault(), this.editor.history.startOperation();
        ...
        if (s) {
            ...
            let e = this.media.importCreation(s),
                t = { address: [1, this.editor.project.media.length], data: e };
    ...
    (PZ.ui.media.list.project.prototype.keydown = async function (e) {
        if ("Delete" === e.key || "Del" === e.key) {
            e.stopPropagation();
            let t = this.el.querySelectorAll(".selected");
            this.editor.history.startOperation(), this.deleteMedia(t), this.editor.history.finishOperation();
        }
        if (e.ctrlKey)
            if ("c" === e.key || "x" === e.key) {
                let t = Array.from(this.el.querySelectorAll(".selected"), (e) => e.pz_object),
                    i = JSON.stringify(t);
                if ((navigator.clipboard.writeText(i), "x" === e.key)) {
                    let e = this.el.querySelectorAll(".selected");
                    this.editor.history.startOperation(), this.deleteMedia(e), this.editor.history.finishOperation();
                }
            } else if ("v" === e.key) {
                let t = await navigator.clipboard.readText(),
                    i = [];
                ...
                for (let e = 0; e < i.length; e++) {
                    let t = new PZ.media();
                    (t.loading = t.load(i[e])), this.editor.project.media.push(t);
                }
            }
    }),
    ...
    (PZ.ui.media.list.project.prototype.dragStart = function (e) {
        ...
        for (let e = 0; e < t.length; e++) this.editor.draggingData.push(t[e].pz_object);
        e.dataTransfer.setData("text", "clip"), e.dataTransfer.setDragImage && e.dataTransfer.setDragImage(this.mediaDragImage, -30, -30);
    }),
    ...
    (PZ.ui.media.search.prototype.search = function () {
        ...
        if (this.searchText !== e) {
            this.searchText = e;
            for (let t = 0; t < this.media.lists.length; t++) this.media.lists[t].search(e);
        }
    }),
    ...
    (PZ.ui.media.title.prototype.createButton = function (e, t, i) {
        ...
        s.appendChild(PZ.ui.generateIcon(t)),
            ...
            (s.onclick = i);
        let n = document.createElement("span");
        (n.innerText = e), (n.style = "margin-left:5px;vertical-align:top;"), s.appendChild(n), this.el.appendChild(s);
    }),
    (PZ.ui.media.title.prototype.create = function () {
        (this.el = document.createElement("div")), this.el.classList.add("media-title"), this.el.classList.add("noselect"), (this.nameEl = document.createElement("span")), (this.nameEl.innerText = "Media"), this.el.appendChild(this.nameEl);
    }),
    (PZ.ui.media.title.old = function () {
        this.createButton("Upload", "upload", function () {}), this.createButton("Filter", "filter", function () {});
    }),
    ...
    (PZ.ui.timeline.prototype.selectionChanged = function () {
        ...
        if (0 !== e.length) {
            for (var t = Number.POSITIVE_INFINITY, i = 0, s = 0; s < e.length; s++) (t = Math.min(t, e[s].start)), (i = Math.max(i, e[s].start + e[s].length));
        ...
        } else this.selectionShadow.style.display = "none";
    }),
    (PZ.ui.timeline.prototype.create = function () {
        var e = this;
        (this.el.onkeydown = this.keydown.bind(this)), this.el.addEventListener("wheel", this.mouseWheel.bind(this));
        var t = document.createElement("div"),
        ...
        (i.style = "position:absolute;top:0;left:0;height:35px;width:200px;background-color: #1D1D1D;"),
            ...
            (this.timerule_drag = new PZ.ui.drag(
                this.timerule,
                function (t) {
                    e.el.focus(), (this.origin = e.tracks.container.getBoundingClientRect().left);
                },
                function (e) {
    ...
    (PZ.ui.timeline.prototype.update = function () {
        (this.animFrameReq = requestAnimationFrame(this._updateFn)), (this.timestamp.innerText = this.formatTime(this.editor.playback.currentTime));
        var e,
            t = 200 * this.zoom;
        let i = 1 / this.zoom,
            s = Math.min(Math.max(Math.floor(Math.log10(0.5 * i)) + 1, 0), 4);
        ...
        for (let e = 0; e < this.timelabels.length; e++) {
            ...
            (t.style.left = o + e * r + "px"), (t.style.width = 0.5 * r + "px"), (t.innerText = this.formatTime((e + Math.floor(a / r)) * n));
        }
        for (let e = 0; e < this.markers.length; e++) {
            let t = this.markers[e];
            (t.style.left = this.frameToPx(t.pz_marker.frame) - a + "px"), (t.innerText = t.pz_marker.value);
        }
    ...
    (PZ.ui.timeline.prototype.resize = function () {
        ...
        let i = this.timerule.clientWidth,
            s = Math.ceil(i / 200);
        this.timelabels.splice(s).forEach((e) => e.remove()), (this.timelabels.length = s);
        for (var n = 0; n < this.timelabels.length; n++)
            if (!this.timelabels[n]) {
                let e = document.createElement("div");
                e.classList.add("timelabel"), this.timerule.insertBefore(e, this.timerule.firstElementChild), (this.timelabels[n] = e);
            }
        this.sequence && (this.keyframes.zoom(), this.tracks.zoom()), this.tracks.verticalZoom();
    }),
    (PZ.ui.timeline.prototype.formatTime = function (e) {
        ...
        if (1 === this.timeFormat) {
            var s = this.editor.playback.frameRate,
                n = Math.round(e * s) % s;
            (t = e / 60), (i = Math.floor(t / 60));
            return (t = Math.floor(t % 60)), (e = Math.floor(e % 60)), ("0" + i).slice(-2) + ":" + ("0" + t).slice(-2) + ":" + ("0" + e).slice(-2) + ":" + ("0" + n).slice(-2);
        }
    ...
    (PZ.ui.timeline.prototype.keepInView = function (e) {
        var t = this.scrollBar,
            ...
            s = 0;
        (e -= t.scrollLeft) - 50 < 0 ? (s = e - 50) : e - i + 50 > 0 && (s = e - i + 50), (t.scrollLeft += s / 5);
    }),
    ...
    (PZ.ui.timeline.prototype.setFrame = function (e) {
        ...
        (this.editor.playback.speed = 0), (this.editor.playback.currentFrame = Math.max(Math.min(t, i - 1), 0));
    }),
    ...
    (PZ.ui.timeline.prototype.mouseWheel = function (e) {
        if (true === e.ctrlKey) {
            ...
            0 !== i && ((this.scrollBar.scrollLeft += i), e.preventDefault());
        }
    }),
    ...
    (PZ.ui.timeline.keyframes.prototype.create = function () {
        ...
        (this.el = document.createElement("div")),
            ...
            (this.resize_drag = new PZ.ui.drag(
                this.resize,
                function (t) {
                    (this.startHeight = parseFloat(e.keyframes.el.style.height)), (this.startPt = t.pageY);
                },
                function (e) {
                ...
                function () {
                    ...
                    (e.keyframes.el.style.height = t + "px"), (e.keyframes.resize.style.top = t + 35 + "px"), (e.tracks.el.style.top = t + 3 + 35 + "px");
                }
            )),
    ...
    (PZ.ui.timeline.keyframes.prototype.objectsChanged = function () {
        for (; this.container.children.length; ) {
            ...
            e.pz_offsetChanged && this.timeline.sequence.ui.onClipMoved.unwatch(e.pz_offsetChanged), this.unloadKeyframeTrack(e);
        }
        if (this.objects)
            for (let e = 0; e < this.objects.length; e++) {
                ...
                i && ((t.pz_offset = i.start), (t.pz_offsetChanged = this.objectOffsetChanged.bind(this, t, i)), this.timeline.sequence.ui.onClipMoved.watch(t.pz_offsetChanged));
            }
    }),
    (PZ.ui.timeline.keyframes.prototype.createKeyframeTrack = function (e, t) {
        if (t instanceof PZ.property.static) return;
        let i = document.createElement("div");
        (i.style = "height:20px;line-height:20px;color: #848484;font-size: 15px;box-sizing: border-box;padding: 0 5px;"), (i.style.display = "none"), i.classList.add("noselect"), e.pz_labels.appendChild(i);
        let s = document.createElement("div");
        s.classList.add("kftrack"), (s.style.display = "none"), (s.pz_label = i), (s.pz_object = t);
        let n = Math.max(this.container.clientWidth, parseFloat(this.timeline.scrollBar.firstElementChild.style.width));
        (s.style.width = n + "px"), (s.style.height = "20px"), e.appendChild(s);
        let r = (e) => {
            (i.innerText = e || t.properties.name.get()), (i.title = i.innerText);
        ...
        return this.updateTrackColors(this.container), s;
    }),
    (PZ.ui.timeline.keyframes.prototype.unloadKeyframeTrack = function (e) {
        for (; e.nextElementSibling && !e.nextElementSibling.classList.contains("kftrack"); ) this.unloadTrackList(e.nextElementSibling);
        if (e.pz_object instanceof PZ.property.dynamic.keyframes) for (; e.children.length; ) this.removeKeyframe(e, e.children[0].pz_object);
        e.pz_keyframeCreated &&
    ...
    (PZ.ui.timeline.keyframes.prototype.createTrackList = function (e, t) {
        ...
        let s = document.createElement("div");
        (s.style.display = "contents"), (s.pz_labels = i), (s.pz_parent = e), (s.pz_object = t);
        let n = () => {
            for (; s.children.length; ) this.unloadKeyframeTrack(s.children[0]);
            if (t instanceof PZ.object) this.createKeyframeTrack(s, t);
            else if (Array.isArray(t)) for (let e = 0; e < t.length; e++) this.createKeyframeTrack(s, t[e]);
            else for (let e of t) this.createKeyframeTrack(s, e);
        };
        s.pz_object.onListChanged && ((s.pz_listChanged = n), s.pz_object.onListChanged.watch(s.pz_listChanged)),
            n(),
    ...
    (PZ.ui.timeline.keyframes.prototype.unloadTrackList = function (e) {
        for (; e.children.length; ) this.unloadKeyframeTrack(e.children[0]);
        e.pz_listChanged && e.pz_object.onListChanged.unwatch(e.pz_listChanged), e.pz_labels.remove(), e.remove();
    }),
    (PZ.ui.timeline.keyframes.prototype.objectOffsetChanged = function (e, t) {
        if (t.start !== e.pz_offset) {
            ...
            for (let e = 0; e < s.length; e++) s[e].pz_frame += i;
            this.zoom();
        }
    }),
    ...
    (PZ.ui.timeline.keyframes.prototype.trackKeyframeMoved = function (e, t, i) {
        "none" !== e.style.display && (this.removeKeyframe(e, i), this.addKeyframe(e, i));
    }),
    (PZ.ui.timeline.keyframes.prototype.trackAnimatedChanged = function (e, t) {
        if (t.animated && !t.expression) for (let i = 0; i < t.keyframes.length; i++) this.addKeyframe(e, t.keyframes[i]);
        else for (let i = 0; i < t.keyframes.length; i++) this.removeKeyframe(e, t.keyframes[i]);
    }),
    (PZ.ui.timeline.keyframes.prototype.addKeyframe = function (e, t) {
        ...
        for (; i && !(i.pz_frame >= s); ) i = i.nextElementSibling;
        if (null === i || i.pz_frame !== s) {
            0 === e.children.length && ((e.style.display = ""), (e.pz_label.style.display = ""), this.updateTrackColors(this.container));
            let n = this.createKeyframe(!(t instanceof PZ.keyframe));
            (n.pz_frame = s), (n.style.left = this.timeline.frameToPx(s) + "px"), e.insertBefore(n, i), this.keyframe_drag.addElts(n), this.updateKeyframeColor(n), (i = n);
        }
        this.selectNewKeyframes && i.classList.add("selected"), t instanceof PZ.keyframe ? (i.pz_object = t) : i.pz_children.push(t);
        let n = e.parentElement.pz_parent;
        return n && (i.pz_parent = this.addKeyframe(n, i)), i;
    }),
    (PZ.ui.timeline.keyframes.prototype.removeKeyframe = function (e, t) {
        ...
        for (let s = 0; s < e.children.length; s++) {
            if ((i = e.children[s]).pz_object === t) {
                this.unloadKeyframe(i), i.remove(), 0 === e.children.length && ((e.style.display = "none"), (e.pz_label.style.display = "none"), this.updateTrackColors(this.container));
                break;
            }
            0;
        }
        if (i)
            for (; i.pz_parent; ) {
                (t = i), (e = (i = i.pz_parent).parentElement);
                let s = i.pz_children.indexOf(t);
                0,
                    i.pz_children.splice(s, 1),
                    0 === i.pz_children.length && (this.unloadKeyframe(i), i.remove()),
                    0 === e.children.length && ((e.style.display = "none"), (e.pz_label.style.display = "none"), this.updateTrackColors(this.container));
            }
    }),
    (PZ.ui.timeline.keyframes.prototype.createKeyframe = function (e) {
        let t = document.createElement("div");
        return t.classList.add("keyframe"), e || t.classList.add("kfobject"), (t.pz_frame = 0), e ? (t.pz_children = []) : (t.pz_object = null), t;
    }),
    ...
    (PZ.ui.timeline.keyframes.prototype.snap = function (e, t) {
        if (t) {
            ...
            if (Math.abs(i - e) < 10) return this.timeline.editor.playback.currentFrame;
            let t = this.timeline.sequence.properties.markers.keyframes;
            for (var s = 0; s < t.length; s++) {
                let i = this.timeline.frameToPx(t[s].frame),
                    n = Math.abs(i - e);
                if (n < 10 && n > 0) return t[s].frame;
            }
            let n = this.container.getElementsByClassName("kfobject");
            for (s = 0; s < n.length; s++) {
                if (n[s].classList.contains("selected")) continue;
                let t = parseFloat(n[s].style.left);
                if (Math.abs(t - e) < 10) return n[s].pz_object.frame + n[s].parentElement.pz_object.frameOffset;
            }
        }
    ...
    (PZ.ui.timeline.keyframes.prototype.keydown = async function (e) {
        if ("Delete" === e.key || "Del" === e.key || "Backspace" === e.key) {
            ...
            this.timeline.editor.history.startOperation(), this.deleteKeyframes(t), this.timeline.editor.history.finishOperation();
        } else if ("ArrowLeft" === e.key || "ArrowRight" === e.key) e.ctrlKey;
            ...
            if ("v" === e.key && e.ctrlKey) {
                ...
                for (let e = 0; e < i.length; e++) {
                    if ("propertyList" !== i[e].baseType) return;
                ...
                for (let e = 0; e < n.length; e++) {
                    if (!(n[e].pz_object instanceof PZ.property.dynamic.keyframes) || "none" === n[e].style.display) continue;
                    let t = n[e].pz_object,
                        r = t.frameOffset;
                    for (let e = 0; e < i.length; e++) {
                        let n = i[e].data,
                        ...
                        o && (this.propertyOps.pasteKeyframes(t, o, a), delete n[t.definition.name]);
                    }
                }
            ...
            let n = new PZ.package(i, "propertyList"),
                r = JSON.stringify([n]);
            if ((navigator.clipboard.writeText(r), "x" === e.key)) {
    ...
    (PZ.ui.timeline.keyframes.prototype.selectKeyframe = function (e, t) {
        if (((t = t || 3), e.classList.add("selected"), e.pz_children && 1 & t)) for (let t = 0; t < e.pz_children.length; t++) this.selectKeyframe(e.pz_children[t], 1);
        e.pz_parent && 2 & t && this.selectKeyframe(e.pz_parent, 2);
    }),
    (PZ.ui.timeline.keyframes.prototype.deselectKeyframe = function (e, t) {
        if (((t = t || 3), e.classList.remove("selected"), e.pz_children && 1 & t)) for (let t = 0; t < e.pz_children.length; t++) this.deselectKeyframe(e.pz_children[t], 1);
        e.pz_parent && 2 & t && this.deselectKeyframe(e.pz_parent, 2);
    }),
    (PZ.ui.timeline.keyframes.prototype.deselectAll = function () {
        for (var e = this.container.getElementsByClassName("selected"); e.length; ) e[0].classList.remove("selected");
    }),
    (PZ.ui.timeline.keyframes.prototype.deleteKeyframes = function (e) {
        for (var t = 0; t < e.length; t++) {
            let i = e[t].parentElement.pz_object;
            if (1 === i.keyframes.length && !i.definition.allowEmpty) continue;
            let s = e[t].pz_object,
                n = { property: i.getAddress(), frame: s.frame };
            this.propertyOps.deleteKeyframe(n);
        }
    }),
    (PZ.ui.timeline.keyframes.prototype.updateKeyframeColor = function (e) {
        (e.style.backgroundColor = e.parentElement.pz_color), (e.style.border = "1px solid " + e.parentElement.pz_borderColor);
    }),
    (PZ.ui.timeline.keyframes.prototype.updateKeyframeColors = function (e) {
        for (let t = 0; t < e.children.length; t++) this.updateKeyframeColor(e.children[t]);
    }),
    (PZ.ui.timeline.keyframes.prototype.updateTrackColors = function (e, t) {
        ...
        for (let n = 0; n < e.children.length; n++) {
            let r = e.children[n];
            "none" !== r.style.display && ("contents" === r.style.display ? (t = this.updateTrackColors(r, t)) : ((r.style.backgroundColor = i[t]), (r.pz_label.style.backgroundColor = s[t]), (t = (t + 1) % i.length)));
        }
        return t;
    }),
    (PZ.ui.timeline.keyframes.prototype.zoom = function () {
        let e = this.container.getElementsByClassName("kftrack");
        for (var t = Math.max(this.container.clientWidth, parseFloat(this.timeline.scrollBar.firstElementChild.style.width)), i = 0; i < e.length; i++) e[i].style.width = t + "px";
        let s = this.container.getElementsByClassName("keyframe");
        for (let e = 0; e < s.length; e++) {
            let t = s[e].pz_frame,
    ...
    (PZ.ui.timeline.keyframes.prototype.containerDragStart = function (e) {
        ...
        let s = (e, t) => {
            for (let i = 0; i < e.children.length; i++) {
                let n = e.children[i];
                "none" !== n.style.display && ("contents" === n.style.display ? (t = s(n, t)) : (this.trackTops.set(n, t), this.kftracks.push(n), (n.pz_top = t), (t += parseFloat(n.style.height))));
            }
            return t;
        };
        s(t, 0),
    ...
    (PZ.ui.timeline.keyframes.prototype.containerDrag = function (e) {
        (this.currentPt.x = e.pageX - this.origin.x), (this.currentPt.y = e.pageY - this.origin.y);
    }),
    ...
    (PZ.ui.timeline.keyframes.prototype.keyframeDragStart = function (e) {
        ...
        (this.origin = { x: i.left, y: i.top }), (this.currentPt = { x: (e.pageX - this.origin.x) / this.ctx.timeline.zoom }), (this.kf = e.currentTarget), (this.frameOffset = 0);
    ...
    (PZ.ui.timeline.keyframes.prototype.keyframeDrag = function (e) {
        (this.currentPt.x = e.pageX - this.origin.x), (this.snap = !e.shiftKey), (this.altKey = e.altKey);
    }),
    ...
    (PZ.ui.timeline.keyframes.prototype.cloneKeyframes = function (e) {
        for (var t = 0; t < e.length; t++) {
            ...
            i.hasKeyframe(n.frame) && this.propertyOps.deleteKeyframe({ property: s, frame: n.frame }), this.propertyOps.createKeyframe({ property: s, data: n });
        }
    }),
    (PZ.ui.timeline.keyframes.prototype.initProxies = function (e) {
        ...
        for (let s = 0; s < i.length; s++) {
            let n = i[s].pz_object,
                r = i[s].parentElement;
            e && (n = JSON.parse(JSON.stringify(n))), t(r, n), this.ctx.deselectKeyframe(i[s]), e || this.ctx.removeKeyframe(r, n);
        }
    }),
    (PZ.ui.timeline.keyframes.prototype.unloadProxies = function () {
        for (let e = 0; e < this.kfproxies.length; e++) this.kfproxies[e].remove();
    }),
    ...
    (PZ.ui.timeline.keyframes.prototype.finishMoving = function (e, t) {
        for (let i = 0; i < e.length; i++) {
            ...
            for (let e = 0; e < r.length; e++) {
                ...
                (s[e].oldFrame = i), (s[e].newFrame = t), a.set(s[e], r[e].pz_object);
            }
    ...
    (PZ.ui.timeline.tracks.prototype.sequenceChanged = function () {
        this.deselectClips(), this.selectClips();
    ...
    (PZ.ui.timeline.tracks.prototype.create = function () {
        ...
        (this.videoLabels = document.createElement("div")),
            ...
            (this.videoContainer.onscroll = function (t) {
                (e.tracks.videoLabels.scrollTop = this.scrollTop), (this.scrollBottom = this.totalHeight - this.boundHeight - this.scrollTop);
            }),
            ...
            (this.resize_drag = new PZ.ui.drag(
                this.resize,
                function (t) {
                    (this.maxHeight = e.tracks.el.clientHeight - 4), (this.startHeight = parseFloat(e.tracks.videoContainer.style.height)), (this.startPt = t.pageY);
                },
                function (e) {
                    this.newHeight = this.startHeight + e.pageY - this.startPt;
                },
                function () {
                    ...
                    e.tracks.setContainerSplit(t), e.tracks.verticalZoom();
                },
                function () {}
            )),
        ...
        if (e.ctrlKey) {
            if (0 !== (t = e.shiftKey ? 0 : e.deltaY))
                if (e.currentTarget === i.videoLabels) {
                    ...
                    for (var s = 0; s < i.videoContainer.children.length; s++) (i.videoContainer.children[s].style.height = i.videoTrackSize + "px"), (i.videoLabels.children[s].style.height = i.videoTrackSize + "px");
                    i.verticalZoom(), e.preventDefault(), e.stopPropagation();
                } else if (e.currentTarget === i.audioLabels) {
                    i.audioTrackSize = t < 0 ? Math.min(100, i.audioTrackSize + 5) : Math.max(20, i.audioTrackSize - 5);
                    for (s = 0; s < i.audioContainer.children.length; s++) (i.audioContainer.children[s].style.height = i.audioTrackSize + "px"), (i.audioLabels.children[s].style.height = i.audioTrackSize + "px");
                    i.verticalZoom(), e.preventDefault(), e.stopPropagation();
                }
        } else
            0 !== (t = e.shiftKey ? 0 : e.deltaY) &&
                (e.currentTarget === i.videoLabels || e.currentTarget === i.videoContainer
                    ? (i.videoContainer.scrollTop += Math.sign(t) * i.videoTrackSize * 0.5)
                    : (e.currentTarget !== i.audioLabels && e.currentTarget !== i.audioContainer) || (i.audioContainer.scrollTop += Math.sign(t) * i.audioTrackSize * 0.5),
                e.preventDefault(),
                e.stopPropagation());
    }),
    (PZ.ui.timeline.tracks.prototype.redraw = function () {
        (this.videoLabels.innerHTML = ""), (this.audioLabels.innerHTML = ""), (this.videoContainer.innerHTML = ""), (this.audioContainer.innerHTML = "");
        let e = this.sequence;
        if (e) {
            ...
            for (t = 0; t < e.audioTracks.length; t++) {
                (i = e.audioTracks[t]), (s = this.createTrackLabel(i, 1, t));
                this.audioLabels.appendChild(s);
                for (n = this.createTrackElement(i, 1), r = 0; r < i.clips.length; r++) {
            ...
            this.handle_drag.addElts(l), this.zoom(), this.verticalZoom();
        }
    }),
    (PZ.ui.timeline.tracks.prototype.createClipElement = function (e) {
        var t = document.createElement("div");
        t.classList.add("clip"), (t.pz_object = e), this.clip_drag.addElts(t), (t.oncontextmenu = this.clipContextMenu.bind(this));
        ...
        return n.classList.add("handle"), (n.style = "right:0;border-right-width:3px"), t.appendChild(n), this.handle_drag.addElts(s), this.handle_drag.addElts(n), t;
    }),
    (PZ.ui.timeline.tracks.prototype.createTrackElement = function (e, t) {
        var i = document.createElement("div");
        return (
            (i.style = "position:absolute; background-color: rgb(39, 39, 39); box-sizing: border-box;"),
            (i.pz_object = e),
            0 === t ? ((i.style.borderTop = "1px solid rgb(33, 33, 33)"), (i.style.height = this.videoTrackSize + "px")) : ((i.style.borderBottom = "1px solid rgb(33, 33, 33)"), (i.style.height = this.audioTrackSize + "px")),
            i
        );
    }),
    (PZ.ui.timeline.tracks.prototype.createTrackLabel = function (e, t, i) {
        ...
        let n = document.createElement("span");
        if ((n.classList.add("noselect"), (n.style = "vertical-align: top"), s.appendChild(n), 0 === t)) {
            (s.style.borderTop = "1px solid rgb(33, 33, 33)"), (s.style.height = this.videoTrackSize + "px");
            let t = document.createElement("button");
            (t.title = e.enabled ? "disable track" : "enable track"), (t.style = "width: 16px;height: 16px;vertical-align:inherit;"), t.classList.add("actionbutton");
            let i = PZ.ui.generateIcon("visible");
            (i.style = "width: 16px;height: 16px;"),
                (i.style.fill = e.enabled ? "#ccc" : "#8a2828"),
                t.appendChild(i),
                (t.onclick = () => {
                    (e.enabled = !e.enabled), (t.title = e.enabled ? "disable track" : "enable track"), (i.style.fill = e.enabled ? "#ccc" : "#8a2828");
                }),
                s.appendChild(t);
        } else (s.style.borderBottom = "1px solid rgb(33, 33, 33)"), (s.style.height = this.audioTrackSize + "px");
        let r = document.createElement("button");
        (r.title = "delete track"), (r.style = "width: 16px;height: 16px;vertical-align:inherit;"), r.classList.add("actionbutton");
        let a = PZ.ui.generateIcon("remove");
        return (
            ...
            (r.onclick = () => {
                ...
                this.timeline.editor.history.startOperation();
                for (let t = e.clips.length - 1; t >= 0; t--) this.deleteClip({ type: i.type, oldTrackIdx: i.oldTrackIdx, oldIdx: t });
                this.deleteTrack(i), this.timeline.editor.history.finishOperation();
            }),
            s.appendChild(r),
            s
        );
    ...
    (PZ.ui.timeline.tracks.prototype.snap = function (e, t) {
        ...
        let r = this.sequence;
        if (t) {
            n(0), n(this.timeline.frameToPx(this.timeline.editor.playback.currentFrame));
            ...
            for (a = 0; a < r.videoTracks.length; a++)
                for (var o = r.videoTracks[a], l = 0; l < o.clips.length; l++) {
                    var h = o.clips[l];
                    n(this.timeline.frameToPx(h.start)), n(this.timeline.frameToPx(h.start + h.length));
                }
            for (a = 0; a < r.audioTracks.length; a++)
                for (o = r.audioTracks[a], l = 0; l < o.clips.length; l++) {
                    h = o.clips[l];
                    n(this.timeline.frameToPx(h.start)), n(this.timeline.frameToPx(h.start + h.length));
                }
        }
    ...
    (PZ.ui.timeline.tracks.prototype.keydown = async function (e) {
        if ("Delete" === e.key || "Del" === e.key || "Backspace" === e.key) {
            ...
            this.timeline.editor.history.startOperation(), this.deleteClips(t), this.timeline.editor.history.finishOperation(), this.selectClips(), this.zoom();
        } else if (("c" !== e.key && "x" !== e.key) || !e.ctrlKey) {
            if ("v" === e.key && e.ctrlKey) {
                e.stopPropagation();
                let t = await navigator.clipboard.readText(),
                ...
                this.timeline.editor.history.startOperation(), this.splitClips(t), this.timeline.editor.history.finishOperation(), this.selectClips(), this.zoom();
            } else if ("u" === e.key) {
                e.stopPropagation();
                t = this.container.querySelectorAll(".clip.selected");
                this.timeline.editor.history.startOperation(), this.unlinkClips(t), this.timeline.editor.history.finishOperation();
            } else if ("l" === e.key) {
                e.stopPropagation();
                t = this.container.querySelectorAll(".clip.selected");
                this.timeline.editor.history.startOperation(), this.linkClips(t), this.timeline.editor.history.finishOperation();
            }
        } else {
            e.stopPropagation();
            let i = [];
            for (let e = 0; e < this.videoContainer.children.length; e++) {
                ...
                (s.clips = s.children[0] = new PZ.objectList()), s.clips.push(...t.map((e) => e.pz_object)), i.push(s);
            }
            ...
            let s = new PZ.package(i, "track"),
                n = JSON.stringify([s]);
            if ((navigator.clipboard.writeText(n), "x" === e.key)) {
                var t = this.container.querySelectorAll(".clip.selected");
                this.timeline.editor.history.startOperation(), this.deleteClips(t), this.timeline.editor.history.finishOperation(), this.selectClips(), this.zoom();
            }
        }
    ...
    (PZ.ui.timeline.tracks.prototype.verticalZoom = function () {
        ...
        (n = Math.max(n, s)), (e.totalHeight = n), (e.boundHeight = i.height);
        ...
        for (r = 0; r < e.children.length; r++) {
            a = e.children[r];
            var c = t.children[r];
            (n -= parseFloat(a.style.height)), (a.style.top = n + "px"), c && ((c.style.top = n + "px"), (c.children[0].innerText = "V" + (r + 1)));
        }
        (e.scrollBottom = o), (e.scrollTop = l), (e = this.audioContainer), (t = this.audioLabels), (n = 0);
        for (r = 0; r < e.children.length; r++) {
            (a = e.children[r]), (c = t.children[r]);
            (a.style.top = n + "px"), c && ((c.style.top = n + "px"), (c.children[0].innerText = "A" + (r + 1))), (n += parseFloat(a.style.height));
        }
        (this.waveformContainer.width = this.audioContainer.clientWidth), (this.waveformContainer.height = this.audioContainer.clientHeight);
    }),
    (PZ.ui.timeline.tracks.prototype.zoom = function () {
        for (var e = Math.max(this.videoContainer.clientWidth, this.timeline.frameToPx(this.timeline.editor.playback.totalFrames)), t = this.videoContainer.children, i = 0; i < t.length; i++) {
            ...
            for (var s = 0; s < t[i].children.length; s++) this.resizeClip(t[i].children[s]);
        }
        for (t = this.audioContainer.children, i = 0; i < t.length; i++) {
            this.resizeTrack(t[i], e);
            for (s = 0; s < t[i].children.length; s++) this.resizeClip(t[i].children[s]);
        }
    }),
    (PZ.ui.timeline.tracks.prototype.resizeTrack = function (e, t) {
        (t = t || Math.max(this.videoContainer.clientWidth, this.timeline.frameToPx(this.timeline.editor.playback.totalFrames))), (e.style.width = t + "px");
    }),
    (PZ.ui.timeline.tracks.prototype.resizeClip = function (e) {
        var t = e.pz_object;
        (e.style.left = this.timeline.frameToPx(t.start) + "px"), (e.style.width = this.timeline.frameToPx(t.length) + "px");
        var i = Math.min(50, 0.2 * parseFloat(e.style.width)) + "px",
            s = e.getElementsByClassName("handle");
        s.length > 0 && ((s[0].style.width = i), (s[1].style.width = i));
    }),
    ...
    (PZ.ui.timeline.tracks.prototype.deselectClips = function () {
        for (var e = this.container.getElementsByClassName("clip selected"); e.length; ) e[0].classList.remove("selected");
    }),
    (PZ.ui.timeline.tracks.prototype.deselectHandles = function () {
        for (var e = this.container.getElementsByClassName("handle selected"); e.length; ) e[0].classList.remove("selected");
    }),
    (PZ.ui.timeline.tracks.prototype.insertTrackProxies = function (e) {
        for (var t = 0; t < e.length; t++) {
            ...
            if ((i.remove(), i.children.length > 0)) {
                var r = { type: s, newTrackIdx: n, data: null };
                this.createTrack(r);
                for (var a = (0 === s ? this.videoContainer : this.audioContainer).children[r.newTrackIdx]; i.firstElementChild; ) a.appendChild(i.firstElementChild);
            }
        }
    }),
    (PZ.ui.timeline.tracks.prototype.moveClipProxies = function (e, t, i) {
        ...
        for (var n = 0; n < e.length; n++) {
            for (
                var r = e[n],
                    ...
                    l = r.parentElement,
                    h = Array.prototype.indexOf.call(l.parentElement.children, l),
                    c = l.parentElement === this.videoContainer ? 0 : 1,
                    p = 0,
                    d = 0;
                d < l.children.length;
                d++
                ...
                if ((y = l.children[d]) !== r.pz_clip || t) {
                    if (y.classList.contains("proxy")) break;
                    if (a <= y.pz_object.start) break;
                } else p = -1;
            }
            if (((d += p), (r.type = c), (r.trackIdx = h), (r.idx = d), t)) {
                var u = { type: c, newTrackIdx: h, newIdx: d, start: a, length: o, data: r.pz_object };
                if ((this.createClip(u), this.linkAfterCreation(u, s), i)) for (let t = 0; t < n; t++) e[t].trackIdx.type === c && e[t].trackIdx === h && e[t].idx++;
            } else {
                var m = r.pz_clip,
                    f = m.parentElement;
                u = {
        ...
        for (p = [[], []], n = 0; n < e.length; n++) {
            (r = e[n]), (a = Math.round(this.timeline.pxToFrame(parseFloat(r.style.left)))), (o = Math.round(this.timeline.pxToFrame(parseFloat(r.style.width)))), (l = r.parentElement);
            var y,
                g = r.trackIdx,
                b = ((c = r.type), r.idx + (p[c][g] || 0));
            if (b > 0 && (y = l.pz_object.clips[b - 1]).start + y.length > a) {
                u = { type: c, oldTrackIdx: g, oldIdx: b - 1, length: a - y.start };
                if ((y.properties.time.animated || (u.timeEnd = y.properties.time.get(u.length)), y.start + y.length > a + o)) {
                    let e = { type: c, newTrackIdx: g, newIdx: ++b, start: a + o, length: y.start + y.length - (a + o), offset: a + o - y.start, data: y };
                    (p[c][g] = 1 + (0 | p[c][g])), this.createClip(e);
                    let t = { type: e.type, oldTrackIdx: e.newTrackIdx, oldIdx: e.newIdx, start: e.start, length: e.length, offset: e.offset };
                    this.moveClip(t), this.linkAfterCreation(e, s);
                }
                y.start < a ? this.moveClip(u) : ((p[c][g] = (0 | p[c][g]) - 1), this.unlinkBeforeDeletion(u), this.deleteClip(u));
            }
            for (; (y = l.pz_object.clips[++b]); )
                if (y.start + y.length <= a + o) {
                    u = { type: c, oldTrackIdx: g, oldIdx: b-- };
                    (p[c][g] = (p[c][g] || 0) - 1), this.unlinkBeforeDeletion(u), this.deleteClip(u);
                } else {
                    if (!(y.start < a + o)) break;
                    {
                        let e = { type: c, oldTrackIdx: g, oldIdx: b, start: a + o, length: y.start + y.length - (a + o), offset: a + o - y.start };
                        this.moveClip(e);
                    }
                }
        }
    ...
    (PZ.ui.timeline.tracks.prototype.deleteClips = function (e) {
        for (var t = 0; t < e.length; t++) {
            var i = e[t],
                s = i.parentElement,
                n = { type: s.parentElement === this.videoContainer ? 0 : 1, oldTrackIdx: Array.prototype.indexOf.call(s.parentElement.children, s), oldIdx: Array.prototype.indexOf.call(i.parentElement.children, i) };
            this.unlinkBeforeDeletion(n), this.deleteClip(n);
        }
    }),
        ...
        for (var t = new Map(), i = 0; i < e.length; i++) {
            ...
            if (!(l < 0 || l >= s.pz_object.length)) {
                var h = { type: r, oldTrackIdx: a, oldIdx: o, length: l },
                    c = { type: r, oldTrackIdx: a, newTrackIdx: a, newIdx: o + 1, oldIdx: o + 1, start: s.pz_object.start + l, length: s.pz_object.length - l, offset: -l, data: s.pz_object };
                if (!s.pz_object.properties.time.animated) {
                    let e = s.pz_object.properties.time.get(h.length);
                    (h.timeEnd = e), (c.timeStart = e);
                }
                this.createClip(c), this.moveClip(c), this.moveClip(h), this.linkAfterCreation(c, t);
            }
        }
    }),
    (PZ.ui.timeline.tracks.prototype.linkClips = function (e) {
        if (!(e.length <= 1))
            for (var t = this.sequence.clipLinks.generateKey(), i = 0; i < e.length; i++) {
                var s = e[i].pz_object,
                    n = { clip: s.getAddress(), link: t };
                null !== s.link && this.unlinkClip(n), this.linkClip(n);
            }
    }),
    ...
    (PZ.ui.timeline.tracks.prototype.unlinkClips = function (e) {
        for (var t = 0; t < e.length; t++) {
            ...
            if (null !== i.link) {
                ...
                let e = i.link.key;
                this.unlinkClip(s), this.cleanUpLink(e);
            }
        }
    }),
    ...
    (PZ.ui.timeline.tracks.prototype.update = function () {
        ...
        (this.videoContainer.scrollLeft = e), (this.audioContainer.scrollLeft = e), this.waveform.render();
    }),
            ...
            for (var t = e.children, i = parseFloat(e.style.top) - e.scrollTop, o = 0; o < t.length; o++) {
                ...
                if (!(l + parseFloat(t[o].style.height) < n || n + a < l))
                    for (var h = 0; h < t[o].children.length; h++) {
                        ...
                        if (s <= d && p <= s + r) {
                            if (c.classList.contains("selected")) continue;
                            if (!this.altHeld && c.pz_object.link) for (var u = c.pz_object.link, m = 0; m < u.clips.length; m++) this.ctx.addressToEl(u.clips[m].getAddress()).classList.add("selected");
    ...
    (PZ.ui.timeline.tracks.prototype.createTrack = function (e) {
        ...
        i.splice(e.newTrackIdx, 0, s), s.load(e.data), this.timeline.editor.history.pushCommand(PZ.ui.timeline.tracks.prototype.deleteTrack.bind(this), { type: e.type, oldTrackIdx: e.newTrackIdx }), t.ui.onTrackCreated.update(e);
    }),
    (PZ.ui.timeline.tracks.prototype.trackCreated = function (e) {
        var t,
            i,
            s,
            n = this.timeline.sequence;
        0 === e.type ? ((t = this.videoContainer), (i = this.videoLabels), (s = n.videoTracks)) : ((t = this.audioContainer), (i = this.audioLabels), (s = n.audioTracks));
        var r = s[e.newTrackIdx],
            a = this.createTrackElement(r, e.type),
            o = this.createTrackLabel(r, e.type, e.newTrackIdx);
        t.insertBefore(a, t.children[e.newTrackIdx]), i.insertBefore(o, i.children[e.newTrackIdx]), this.verticalZoom(), this.zoom();
    }),
    (PZ.ui.timeline.tracks.prototype.deleteTrack = function (e) {
        ...
        i.unload(),
            ...
            this.timeline.editor.history.pushCommand(PZ.ui.timeline.tracks.prototype.createTrack.bind(this), { type: e.type, newTrackIdx: e.oldTrackIdx, data: i.toJSON() }),
            t.ui.onTrackDeleted.update(e);
    }),
    (PZ.ui.timeline.tracks.prototype.trackDeleted = function (e) {
        var t, i;
        0 === e.type ? ((t = this.videoContainer), (i = this.videoLabels)) : ((t = this.audioContainer), (i = this.audioLabels));
    ...
    (PZ.ui.timeline.tracks.prototype.clipDragStart = function (e) {
        ...
        if (((this.origin = { x: t.left, y: t.top }), (this.currentPt = { x: (e.pageX - this.origin.x) / this.ctx.timeline.zoom }), (this.clip = e.currentTarget), this.clip.classList.contains("selected"))) this.originalState = true;
            ...
            if (!e.altKey && this.clip.pz_object.link)
                for (var i = this.clip.pz_object.link, s = 0; s < i.clips.length; s++) {
                    ...
                    e.classList.contains("selected") ? (t.get(e).newState = 1) : (e.classList.add("selected"), t.set(e, { newState: 2 }));
                }
            else this.clip.classList.contains("selected") ? (t.get(this.clip).newState = 1) : (this.clip.classList.add("selected"), t.set(this.clip, { newState: 2 }));
            n = Array.from(this.ctx.container.getElementsByClassName("clip selected"));
            let r = 0;
            for (let e = 0; e < n.length; e++) {
                let i = t.get(n[e]);
                0 === i.newState ? (this.ctx.selection.splice(i.idx + r, 1), n[e].classList.remove("selected"), (r -= 1)) : 2 === i.newState && (this.ctx.selection.splice(e + r, 0, n[e].pz_object), (r += 1));
            }
        }
        ...
        function a(e) {
            var t = document.createElement("div");
            t.classList.add("clip"), t.classList.add("proxy"), (t.pz_clip = e), (t.pz_object = e.pz_object), (t.pz_type = 0), (t.pz_start = e.pz_object.start), (t.pz_length = e.pz_object.length), (t.pz_offset = e.pz_object.offset);
            var i = document.createElement("div");
            return (
                (i.style = "position: absolute; left:3px; top:0px; color: #2c323f; white-space: nowrap;"),
            ...
            for (var i, s = e.children.length, n = 0; n < s; n++) {
                ...
                if (0 !== r.length) {
                    ...
                    for (var l = 0; l < r.length; l++) {
                        ...
                        var h = a(r[l]);
                        (h.pz_trackOffset = n - t), (h.pz_type = e === this.ctx.videoContainer ? 0 : 1), (h.style.display = "none"), r[l].parentElement.appendChild(h), this.clip_proxies.push(h);
                    }
                }
            }
        }
    ...
    (PZ.ui.timeline.tracks.prototype.clipDrag = function (e) {
        (this.currentPt.x = e.pageX - this.origin.x), (this.currentPt.y = e.pageY - this.origin.y), (this.snap = !e.shiftKey);
    }),
    (PZ.ui.timeline.tracks.prototype.clipDragUpdate = function () {
        ...
        var s = false,
            n = function (e, t) {
                ...
                for (e += (t = this.ctx.videoContainer).scrollTop, i = 1; i < t.children.length; i++) {
                    var s = t.children[i];
                    if (e > parseFloat(s.style.top) + parseFloat(s.style.height)) break;
                }
                return i - 1;
            }.call(this, this.currentPt.y),
            r = function (e, t) {
                var i;
                for (t = this.ctx.audioContainer, e -= parseFloat(t.style.top), e += t.scrollTop, i = 1; i < t.children.length; i++) {
                    var s = t.children[i];
                    if (e < parseFloat(s.style.top)) break;
                }
                return i - 1;
            }.call(this, this.currentPt.y);
        ...
        if (false !== this.moved) {
            for (h = 0; h < this.clip_proxies.length; h++) {
                ...
                d.remove(), e.children[p].appendChild(d);
            }
            for (h = 0; h < this.clip_proxies.length; h++) {
                var d,
                    u = (d = this.clip_proxies[h]).pz_start + this.deltaFrames,
                    m = this.ctx.timeline.frameToPx(u);
                d.style.left = m + "px";
                var f = d.pz_length,
    ...
    (PZ.ui.timeline.tracks.prototype.clipDragEnd = function (e) {
        if (e.shiftKey && false === this.moved && true === this.originalState) {
            ...
            else this.clip.classList.contains("selected") && (s.get(this.clip).newState = 0);
            n = Array.from(this.ctx.container.getElementsByClassName("clip selected"));
            let r = 0;
            for (let e = 0; e < n.length; e++) {
                let t = s.get(n[e]);
                0 === t.newState ? (this.ctx.selection.splice(t.idx + r, 1), n[e].classList.remove("selected"), (r -= 1)) : 2 === t.newState && (this.ctx.selection.splice(e + r, 0, n[e].pz_object), (r += 1));
            }
        }
        this.ctx.timeline.editor.history.startOperation(),
            ...
            this.ctx.timeline.editor.history.finishOperation();
        for (i = 0; i < this.clip_proxies.length; i++) this.clip_proxies[i].remove();
        this.ctx.verticalZoom(), this.ctx.timeline.updateZoom();
    }),
    (PZ.ui.timeline.tracks.prototype.clipContextMenu = function (e) {
        let t = e.currentTarget;
        if (t.classList.contains("pz-listitem-edit")) return;
        var i = t.children[0];
        ...
        let a = () => {
            var e = r.value;
            if ((r.remove(), (i.style.display = ""), t.classList.remove("pz-listitem-edit"), e !== n)) {
                let t = new PZ.ui.properties(this.timeline.editor);
                this.timeline.editor.history.startOperation(), t.setValue({ property: s.getAddress(), value: e, oldValue: n }), this.timeline.editor.history.finishOperation();
            }
        };
        (r.onmousedown = r.onclick = r.ontouchstart = function (e) {
            ...
            (r.onkeydown = function (e) {
                "Enter" === e.key ? (this.blur(), e.preventDefault()) : "Escape" === e.key && ((this.value = n), this.blur(), e.preventDefault()), e.stopPropagation();
            }),
            (r.onblur = function (e) {
                a();
            }),
    ...
    (PZ.ui.timeline.tracks.prototype.moveClip = function (e) {
        ...
        var t,
            ...
            s,
            n,
            r = this.timeline.sequence,
            a = 0 === e.type ? r.videoTracks : r.audioTracks,
            o = a[e.oldTrackIdx],
            l = a[e.newTrackIdx];
        ...
        if (
            ...
            if ((c.forEachItemOfType(PZ.property.dynamic.keyframes, (t) => t.shiftKeyframes(e.offset)), !c.properties.time.animated)) {
                ...
                (c.properties.time.keyframes[0].frame = 0), (c.properties.time.keyframes[1].frame = c.length);
            }
            e.offset = -e.offset;
        }
        void 0 !== e.scale &&
    ...
    (PZ.ui.timeline.tracks.prototype.clipMoved = function (e) {
        ...
        if (e.oldTrackIdx !== e.newTrackIdx || e.oldIdx !== e.newIdx) {
            ...
            i.remove(), s.insertBefore(i, s.children[e.newIdx]);
        }
        this.resizeClip(i);
    }),
    (PZ.ui.timeline.tracks.prototype.createClip = function (e) {
        ...
        i.clips.splice(e.newIdx, 0, s),
            ...
            this.timeline.editor.history.pushCommand(PZ.ui.timeline.tracks.prototype.deleteClip.bind(this), { type: e.type, oldTrackIdx: e.newTrackIdx, oldIdx: e.newIdx }),
    ...
    (PZ.ui.timeline.tracks.prototype.clipCreated = function (e) {
        ...
        s.insertBefore(n, s.children[e.newIdx]), this.resizeClip(n);
    }),
    ...
    (PZ.ui.timeline.tracks.prototype.linkClip = function (e) {
        ...
        (i.link = t.clipLinks.link(e.link, i)), this.timeline.editor.history.pushCommand(PZ.ui.timeline.tracks.prototype.unlinkClip.bind(this), { clip: e.clip });
    }),
    (PZ.ui.timeline.tracks.prototype.unlinkClip = function (e) {
        var t = this.timeline.sequence,
            i = t.addressLookup(e.clip, 1),
            s = i.link.key;
        t.clipLinks.unlink(s, i), (i.link = null), this.timeline.editor.history.pushCommand(PZ.ui.timeline.tracks.prototype.linkClip.bind(this), { clip: e.clip, link: s });
    }),
    (PZ.ui.timeline.tracks.prototype.cleanUpLink = function (e) {
        let t = this.timeline.sequence.clipLinks.links[e];
        t && 1 === t.clips.length && this.unlinkClip({ clip: t.clips[0].getAddress() });
    }),
    (PZ.ui.timeline.tracks.prototype.handleDragStart = function (e) {
        ...
        else this.handle.classList.add("selected");
        (this.rate = this.ctx.timeline.sequence.properties.rate.get()), (this.adjustTime = !e.ctrlKey && !this.clip.pz_object.properties.time.animated), (this.rateStretch = e.ctrlKey);
        var r = this.ctx.container.getElementsByClassName("handle selected");
        (this.selected_handles = []), (this.clip_proxies = []);
        for (n = 0; n < r.length; n++) {
            ...
            if (l || !c) {
                ...
                p.classList.add("clip"),
                    ...
                    (p.pz_offset = 0),
                    this.adjustTime ? ((p.pz_timeStart = o.pz_object.properties.time.keyframes[0].value), (p.pz_timeEnd = o.pz_object.properties.time.keyframes[1].value)) : (p.pz_scale = 1),
    ...
    (PZ.ui.timeline.tracks.prototype.handleDrag = function (e) {
        (this.currentPt.x = e.pageX - this.origin.x), (this.snap = !e.shiftKey);
    }),
    (PZ.ui.timeline.tracks.prototype.handleDragUpdate = function () {
        ...
        if (false !== this.moved) {
            ...
            for (s = 0; s < this.clip_proxies.length; s++) {
                ...
                } else r.leftHandle && (a = n = Math.max(n, -r.pz_object.start)), r.rightHandle && (o = n);
                (n = Math.min(n, r.pz_object.length + o - 1)), (n = Math.max(n, -r.pz_object.length + a + 1));
            }
            for (s = 0; s < this.clip_proxies.length; s++) {
                ((r = this.clip_proxies[s]).pz_start = r.pz_object.start),
                    (r.pz_length = r.pz_object.length),
                    r.leftHandle && ((r.pz_start += n), (r.pz_length -= n), this.adjustTime && ((r.pz_offset = -n), (r.pz_timeStart = r.pz_object.properties.time.keyframes[0].value), (r.pz_timeStart += n / this.rate))),
                    r.rightHandle && ((r.pz_length += n), this.adjustTime && ((r.pz_timeEnd = r.pz_object.properties.time.keyframes[1].value), (r.pz_timeEnd += n / this.rate))),
                ...
                (r.style.left = l + "px"), (r.style.width = h + "px");
            }
        }
    }),
    (PZ.ui.timeline.tracks.prototype.handleDragEnd = function (e) {
        if (e.shiftKey && false === this.moved && true === this.originalState)
            ...
            else this.handle.classList.remove("selected");
        this.ctx.timeline.editor.history.startOperation(), this.moved && this.ctx.moveClipProxies(this.clip_proxies), this.ctx.timeline.editor.history.finishOperation();
        for (s = 0; s < this.clip_proxies.length; s++) this.clip_proxies[s].remove();
        this.ctx.selectClips(), this.ctx.zoom();
    }),
    (PZ.ui.timeline.tracks.prototype.mediaDragOver = function (e) {
        e.preventDefault(), this.mediaDragCtx ? ((e.dataTransfer.dropEffect = "copy"), this.clip_drag.move.call(this.mediaDragCtx, e)) : (e.dataTransfer.dropEffect = "none");
    }),
    (PZ.ui.timeline.tracks.prototype.createProxiesFromFragments = function (e, t) {
        ...
        for (let t = 0; t < e.length; t++) {
            if ("track" !== e[t].baseType) return i;
            (e[t].minFrame = Number.POSITIVE_INFINITY), (e[t].maxFrame = 0);
            let n = e[t].data;
        ...
        function n(e) {
            var t = document.createElement("div");
            t.classList.add("clip"), t.classList.add("proxy"), (t.pz_object = e);
            var i = document.createElement("div");
            return (
                (i.style = "position: absolute; left:3px; top:0px; color: #1c2e55; white-space: nowrap;"),
        ...
        function r() {
            var e = document.createElement("div");
            return (e.style = "height:40px; position:absolute; box-sizing: border-box;"), e;
        }
        let a = 0,
            o = 0;
        for (var l = 0; l < e.length; l++) {
            ...
            for (s = 0; s < r.length; s++) {
                ...
                for (var h = 0; h < e.clips.length; h++) {
                    let t = e.clips[h],
                        s = n(t);
                    (s.pz_trackOffset = 0 === e.type ? d : u), (s.pz_start = t.start + c), (s.pz_length = t.length), (s.pz_offset = t.offset), (s.pz_type = e.type), (s.pz_object = t), (s.style.display = "none"), i.clip_proxies.push(s);
                }
                0 === e.type ? d++ : u++;
            }
            (a = Math.max(a, d)), (o = Math.max(o, u)), (t += p);
        }
        for (l = 0; l < a; l++) {
            var c = r();
            this.timeline.tracks.videoContainer.appendChild(c), i.track_proxies.push(c);
        }
        for (l = 0; l < o; l++) {
            c = r();
            this.timeline.tracks.audioContainer.appendChild(c), i.track_proxies.push(c);
        }
        return i;
    }),
    (PZ.ui.timeline.tracks.prototype.mediaDragEnter = function (e) {
        ...
        if (!t) return;
        if (this.mediaDragCtx) return void this.mediaDragCtx.refCount++;
    ...
    (PZ.ui.timeline.tracks.prototype.mediaDragLeave = function (e) {
        if ((e.preventDefault(), !this.mediaDragCtx)) return;
        if ((this.mediaDragCtx.refCount--, 0 !== this.mediaDragCtx.refCount)) return;
        let t = this.mediaDragCtx;
        this.clip_drag.stopDragging(t, e);
        for (var i = 0; i < t.track_proxies.length; i++) t.track_proxies[i].remove();
        for (i = 0; i < t.clip_proxies.length; i++) t.clip_proxies[i].remove();
        this.mediaDragCtx = null;
    }),
    (PZ.ui.timeline.tracks.prototype.mediaDrop = function (e) {
        e.preventDefault(), (this.mediaDragCtx.refCount = 0);
        let t = this.mediaDragCtx;
        this.clip_drag.stopDragging(t, e), (t.deltaFrames = 0), this.clip_drag.end.call(t, e), (this.mediaDragCtx = null);
    }),
    ...
    (PZ.ui.toolbar.prototype.create = function () {
        for (var e = 0; e < this.buttons.length; e++)
            if (this.buttons[e].separator) {
                ...
                (t.style = "width:15px;display:inline-block;height:25px;"), this.el.appendChild(t);
            } else if (this.buttons[e].icon) {
                var i = document.createElement("button");
                (i.title = this.buttons[e].title), (i.cmd = this.buttons[e]), (i.onclick = this.click.bind(this));
        ...
        if (!this.shouldIgnoreKeydown(e.target, e.key) && this.enabled)
            for (var t = (e.shiftKey << 2) | (e.ctrlKey << 1) | (e.altKey << 0), i = 0; i < this.buttons.length; i++) {
                ...
                if (s.key && s.key === e.key) {
                    if ((s.modifierMask || 0) === t) return s.fn.call(this), e.preventDefault(), void e.stopPropagation();
                }
            }
    }),
    ...
    (PZ.ui.waveform.prototype.analyzeBuffer = function (e, t, i) {
        ...
        o.set(i.minBuf), l.set(i.maxBuf), (i.minBuf = o), (i.maxBuf = l);
        let h = [];
        for (var c = 0; c < e.numberOfChannels; c++) h.push(new Float32Array(s));
        let p = 1 / e.numberOfChannels;
        for (var d = 0; d < r; d++) {
            var u = 0,
                m = 0,
                f = d * s;
            for (c = 0; c < e.numberOfChannels; c++) e.copyFromChannel(h[c], c, f);
            for (var y = 0; y < s; y++) {
                let t = 0;
                for (c = 0; c < e.numberOfChannels; c++) t += h[c][y] * p;
                (u = Math.min(t, u)), (m = Math.max(t, m));
            }
            (o[a + d] = 127 * u), (l[a + d] = 127 * m);
        }
    }),
    (PZ.ui.waveform.prototype.decodeSegment = async function (e) {
        var t = await PZ.av.remux(e);
        if (((e.startOffset = Math.max(e.startTime - t.offset, 0)), !t.buffer)) return null;
            ...
            let s = this.bufferCache.get(e),
                ...
                r = {
                    getVideoFrame: async function () {
                        let i = { file: { name: e.filename || "audio.ogg", data: e.file }, startTime: 0, duration: 15, typeMask: 2 };
                        for (;;) {
                            let e = await n.decodeSegment(i);
                            if (!e) break;
                            if ((n.analyzeBuffer(e, i, s), e.duration < i.duration)) break;
                            i.startTime += i.duration;
                        }
                        return PZ.av.stop(), t(), await new Promise(function () {});
                    },
                };
            PZ.av.encode(r, { width: 426, height: 240, rate: 30, quality: 2, format: "mkv_vp8_opus", start: 0, length: 1 });
        });
    }),
    (PZ.ui.waveform.prototype.analyzeMedia = async function (e) {
        if (!e) return;
        let t = { pointsPerSec: 200, minBuf: new Int8Array(0), maxBuf: new Int8Array(0) };
        for (this.bufferCache.set(e, t); this.analyzeLoading; ) await this.analyzeLoading;
        (this.analyzeLoading = this.analyze(e)), await this.analyzeLoading, (this.analyzeLoading = null);
    }),
    (PZ.ui.waveform.prototype.renderClip = function (e, t) {
        if (t.classList.contains("proxy")) return;
        var i = this.bufferCache.get(t.pz_object.media.asset);
        if (!i) return void this.analyzeMedia(t.pz_object.media.asset);
        if (!i.pointsPerSec) return;
        ...
        for (var h = s; h < s + n; h += 1) {
            ...
            let t = 0,
                s = 0;
            for (var p = 0; p < l; p++) (t = Math.max(t, i.maxBuf[c + p])), (s = Math.min(s, i.minBuf[c + p]));
            var d = Math.abs(t - s);
            e.fillRect(h, 256 - d, 1, d);
        }
    }),
    (PZ.ui.waveform.prototype.renderTrack = function (e, t) {
        for (var i = t.children, s = 0; s < i.length; s++) e.save(), e.translate(parseFloat(i[s].style.left), 0), this.renderClip(e, i[s]), e.restore();
    }),
    (PZ.ui.waveform.prototype.render = function () {
        if (this.needsUpdate) {
            var e = this.canvas.getContext("2d");
            e.clearRect(0, 0, this.canvas.width, this.canvas.height), (e.fillStyle = "#242d42"), e.save(), e.translate(-this.timeline.scrollBar.scrollLeft, -this.timeline.tracks.audioContainer.scrollTop);
            for (var t = this.timeline.tracks.audioContainer.children, i = 0; i < t.length; i++)
                e.save(), e.translate(0, parseFloat(t[i].style.top) + 1), e.scale(1, (parseFloat(t[i].style.height) - 2) / 256), this.renderTrack(e, t[i]), e.restore();
            e.restore();
        }
    }),
    (PZ.ui.feedback = class extends PZ.ui.panel.nav {
        constructor(e) {
            super(e), (this.title = "Feedback"), (this.icon = "feedback"), (this.el.style.backgroundColor = "#2a2a2a"), (this.feedback = { type: 0, message: "" }), (this.lastSent = null), (this.el.style.overflowY = "auto"), this.create();
        }
        create() {
            this.navigate(this.createMainPage());
        }
        createMainPage() {
            ...
            var i, s;
            return (
                e.appendChild(PZ.ui.controls.legacy.generateDescription({ content: "Your feedback is always appreciated and is used to improve the app." })),
                ...
                e.appendChild(
                    PZ.ui.controls.legacy.generateDropdown({
                        ...
                        set: function (e) {
                            (t.feedback.type = e), (i.style.display = 3 === e ? "" : "none"), (s.style.display = 3 !== e ? "" : "none");
                        },
                    })
                ),
                (s = document.createElement("div")),
                ...
                s.appendChild(
                    PZ.ui.controls.legacy.generateButton({
                        ...
                        clickfn: function () {
                            if (t.feedback.message.length < 10) return;
                            if (t.feedback.message.length > 1500) return;
                            if (null !== t.lastSent && Date.now() - t.lastSent < 1e4) return;
                            t.lastSent = Date.now();
                            t.editor.sendDiagnostics(),
                                PZ.api("/feedback", "post", { feedbackSource: 0, feedbackType: t.feedback.type, feedbackCategory: 0, toolVersion: PZVERSION, message: t.feedback.message }).then(
                                    function () {
                ...
                ((i = e.appendChild(
                    PZ.ui.controls.legacy.generateDescription({ content: 'Please <a target="_blank" href="/discussions">create a discussion</a> to ask your questions as we cannot respond directly to feedback.' })
                )).style.display = "none"),
                e
            );
        }
        ...
        createFailurePage() {
            ...
            return e.appendChild(PZ.ui.controls.legacy.generateDescription({ content: "Sorry, your feedback could not be sent. Please try again later." })), e;
        }
    }),
    (PZ.ui.about = class extends PZ.ui.panel {
        ...
        create() {
            this.el.appendChild(PZ.ui.controls.legacy.generateTitle({ title: this.editor.name })),
                this.el.appendChild(PZ.ui.controls.legacy.generateDescription({ content: 'Copyright 2019 Panzoid<br><a target="_blank" href="/about/terms">Terms</a> · <a target="_blank" href="/about/privacy">Privacy</a>' })),
                this.el.appendChild(PZ.ui.controls.legacy.generateSpacer()),
                this.el.appendChild(PZ.ui.controls.legacy.generateDescription({ content: this.editor.name + " " + PZTOOLVERSION + "<br>Core " + PZVERSION + "<br>UI 1.0.72" })),
    ...
    (PZ.ui.widget3d.prototype.objectsChanged = function () {
        ...
        if (((this.threeObj = null), (this.position = null), (this.rotation = null), (this.scale = null), this.objects && 1 === this.objects.length && this.objects[0] instanceof PZ.object3d && (e = this.objects[0]), e && e.threeObj)) {
            ...
            for (let e of i) {
                ...
                if ("Position" === i) this.position = e;
                else if ("Rotation" === i) this.rotation = e;
                else {
                    if ("Scale" !== i) continue;
                    this.scale = e;
                }
    ...
    (PZ.ui.widget3d.prototype.keydown = function (e) {
        "1" === e.key
            ...
            : "4" === e.key && (this.mode = PZ.ui.widget3d.mode.NONE),
            this.updateMode();
    }),
    (PZ.ui.widget3d.prototype.updateMode = function () {
        if ((this.controls.detach(), this.mode === PZ.ui.widget3d.mode.POSITION)) this.controls.setMode("translate");
        else if (this.mode === PZ.ui.widget3d.mode.ROTATION) this.controls.setMode("rotate");
        else {
            if (this.mode !== PZ.ui.widget3d.mode.SCALE) return;
    ...
    (PZ.ui.widget3d.prototype.dragStart = function () {
        this.mode === PZ.ui.widget3d.mode.POSITION
            ? ((this.property = this.position), (this.objectProperty = this.controls.object.position))
            : this.mode === PZ.ui.widget3d.mode.ROTATION
            ? ((this.property = this.rotation), (this.objectProperty = this.controls.object.rotation))
            : this.mode === PZ.ui.widget3d.mode.SCALE && ((this.property = this.scale), (this.objectProperty = this.controls.object.scale)),
    ...
    (PZ.ui.widget2d.prototype.objectsChanged = function () {
        ...
        (this.position = null),
            ...
            e && ((this.position = e.properties.position), (this.rotation = e.properties.rotation), (this.resolution = e.properties.resolution), (this.scale = e.properties.scale)),
            (this.edit = this.edit);
    }),
    ...
    (PZ.ui.widget2d.prototype.update = function (e) {
        ...
        parseFloat(this.viewport.canvas.style.left), parseFloat(this.viewport.canvas.style.top);
        let t,
            i,
            s,
            n = "";
        (i = (t = this.resolution.get())[0]),
            ...
            (n += " translate(" + (t[0] * this.ratio - 0.5 * i) + "px, " + (-t[1] * this.ratio - 0.5 * s) + "px)"),
    ...
    (PZ.ui.widget2d.prototype.dragUpdate = function () {
        let e = this.currentPt.x - this.startPt.x,
            ...
            i = new Array(2);
        (i[0] = this.initialValue[0] + e / this.ctx.ratio), (i[1] = this.initialValue[1] - t / this.ctx.ratio), this.property.set(i, this.frame);
    }),
    (PZ.ui.widget2d.prototype.dragEnd = function (e, t) {
        this.ctx.propertyOps.setValue({ property: this.property.getAddress(), frame: this.frame, oldValue: this.initialValue }), t ? this.ctx.editor.history.discardOperation() : this.ctx.editor.history.finishOperation();
    }),
    ...
    (PZ.ui.widget2d.prototype.resizeDragUpdate = function () {
        ...
        if (this.property === this.ctx.scale) {
            ...
            ((e = new Array(2))[0] = this.initialValue[0] + this.direction.x * (t - this.initialPos)), (e[1] = this.initialValue[1] + this.direction.y * (t - this.initialPos));
        } else {
    ...
    (PZ.ui.helper3d.prototype.objectsChanged = function () {
        let e;
        if ((this.helper && (this.viewport.threeObj.remove(this.helper), (this.helper = null)), this.objects && 1 === this.objects.length && this.objects[0] instanceof PZ.object3d && (e = this.objects[0]), e))
            if (e instanceof PZ.object3d.camera) (this.helper = new THREE.CameraHelper(e.threeObj)), this.helper.layers.set(1), this.viewport.threeObj.add(this.helper);
    ...
    (PZ.ui.export = class extends PZ.ui.panel.nav {
        ...
        createMainPage() {
            ...
            (i.style = "fill:#ccc;width:60px;height:60px;flex: 0 0 60px;margin-right: 10px"), t.appendChild(i);
            var s = document.createElement("div");
            (s.style = "display:inline-block"), s.appendChild(document.createTextNode("Device render"));
            ...
            (a.style = "fill:#ccc;width:60px;height:60px;flex: 0 0 60px;margin-right: 10px"), r.appendChild(a);
            var o = document.createElement("div");
            (o.style = "display:inline-block"), o.appendChild(document.createTextNode("Single frame capture"));
    ...
    (PZ.ui.export.cloud = class {
                    ...
                    PZ.ui.controls.legacy.generateDropdown(
                        {
                            ...
                            set: function (e) {
                                (this.params.width = PZ.ui.export.resolutions[e].x), (this.params.height = PZ.ui.export.resolutions[e].y), this.updateQuote();
                            },
                        },
                        this
                    )
                    ...
                    PZ.ui.controls.legacy.generateDropdown(
                        {
                            ...
                            set: function (e) {
                                (this.params.rate = 0 === e ? 30 : 60), this.updateProject_bound();
                            },
                        },
                        this
                    )
                    ...
                    PZ.ui.controls.legacy.generateDropdown(
                        {
                            ...
                            set: function (e) {
                                (this.params.quality = e), this.updateQuote();
                            },
                        },
                        this
                    )
                    ...
                    PZ.ui.controls.legacy.generateDropdown(
                        {
                            ...
                            set: function (e) {
                                (this.params.format = this.CLOUD_FORMATS[e]), this.updateQuote();
                            },
                        },
                        this
                    )
        ...
        createPaymentPage() {
            ...
            new Promise(async (n, r) => {
                ...
                a.status;
                let o = await a.text();
                (s.style.backgroundColor = "#ddd"), (s.style.padding = "10px 5px");
                let l = await braintree.dropin.create({ authorization: o, container: s, paypal: { flow: "vault" } });
                i.remove(), (s.style.display = "");
                e.appendChild(PZ.ui.controls.legacy.generateSpacer());
                let h = e.appendChild(
                    PZ.ui.controls.legacy.generateButton({
                        title: "Next",
        ...
        createServicesPage() {
            ...
            let s = (e) => {
                ...
                const r = () => {
                        e.enabled && e.params.validate()
                            ? (t.setAttribute("aria-checked", "true"), (i.style.display = ""), (s.style.display = ""))
                            : (t.setAttribute("aria-checked", "false"), (i.style.display = "none"), (s.style.display = "none"));
                    },
                    a = !e;
                let o;
                (t = document.createElement("button")).setAttribute("role", "checkbox"),
                    ...
                    n.appendChild(t),
                    e
                        ? ((o = document.createElement("img")).setAttribute("src", "/img/sso/" + e.connectionType + ".svg"), (o.title = e.connectionType), (o.style = "width:50px; height:50px; padding: 5px"))
                        : (((o = PZ.ui.generateIcon("download")).title = "Download"), (o.style = "width:40px; height:40px; padding:10px; fill: #ccc")),
                    n.appendChild(o);
                const l = e ? e.accountName : "Download";
                let h = document.createElement("div");
                if (((h.title = l), (h.innerText = l), (h.style = "color: #ccc; font-size: 18px; align-self: center; overflow: hidden; text-overflow: ellipsis;"), n.appendChild(h), e)) {
                    ((s = document.createElement("button")).title = "edit destination options"), (s.style = "display: none; flex-grow: 1; align-self: center; text-align: right;");
            ...
            new Promise(async (n, r) => {
                ...
                try {
                    ...
                    e.ok && ((this.connections = await e.json()), (this.connections = this.connections.filter((e) => "YouTube" === e.connectionType)));
                } catch (e) {}
                if ((i.remove(), t.appendChild(s()), this.connections && this.connections.length > 0))
                    ...
                    let e = document.createElement("div");
                    if (((e.style = "padding: 10px; color: #ccc;"), this.connections)) {
                    ...
                    } else e.innerHTML = "There was a problem loading your connections.";
                    t.appendChild(e);
                }
        ...
        createConfirmationPage() {
            ...
            return (
                ...
                e.appendChild(PZ.ui.controls.legacy.generateSpacer()),
                e.appendChild(PZ.ui.controls.legacy.generateDescription({ content: 'By clicking Start you agree to Panzoid\'s <a href="/about/terms" target="_blank" style="color:#aaa">terms of service</a>.' })),
        ...
        createProgressPage(e) {
            ...
            this.upload(s)
                .then((e) => {
                    clearInterval(t), e ? this.export.navigate(this.createFinishedPage(e)) : this.export.navigate(this.createErrorPage());
                })
                .catch((e) => {
                    this.export.navigate(this.createErrorPage()), s.sendDiagnostics(e);
                });
            let r = i.appendChild(
                    ...
                    PZ.ui.controls.legacy.generateDropdown(
                        {
                            ...
                            set: function (e) {
                                (this.params.width = PZ.ui.export.resolutions[e].x), (this.params.height = PZ.ui.export.resolutions[e].y);
                            },
                        },
                        this
                    )
                    ...
                    PZ.ui.controls.legacy.generateDropdown(
                        {
                            ...
                            set: function (e) {
                                (n.categoryId = PZ.ui.export.YouTube.categories[e].id), i();
                            },
                        },
                        this
                    )
                    ...
                    PZ.ui.controls.legacy.generateDropdown(
                        {
                            ...
                            set: function (e) {
                                (n.privacyStatus = PZ.ui.export.YouTube.privacyOptions[e]), i();
                            },
                        },
                        this
                    )
                    ...
                    PZ.ui.controls.legacy.generateDropdown(
                        {
                            ...
                            set: function (e) {
                                (n.license = PZ.ui.export.YouTube.licenseOptions[e].id), i();
                            },
                        },
                        this
                    )
    ...
    (function (e, t) {
                            ...
                            var e = /\blang(?:uage)?-([\w-]+)\b/i,
                                ...
                                s = (t.Prism = {
                                    ...
                                    util: {
                                        encode: function (e) {
                                            return e instanceof n
                                                ? new n(e.type, s.util.encode(e.content), e.alias)
                                                : "Array" === s.util.type(e)
                                                ? e.map(s.util.encode)
                                                : e
                                                      .replace(/&/g, "&amp;")
                                        ...
                                        clone: function (e, t) {
                                            ...
                                            switch (((t = t || {}), i)) {
                                                case "Object":
                                                    ...
                                                    var n = {};
                                                    for (var r in ((t[s.util.objId(e)] = n), e)) e.hasOwnProperty(r) && (n[r] = s.util.clone(e[r], t));
                                                    return n;
                                                case "Array":
                                                    if (t[s.util.objId(e)]) return t[s.util.objId(e)];
                                                    n = [];
                                        ...
                                        insertBefore: function (e, t, i, n) {
                                            ...
                                            for (var l in r)
                                                if (r.hasOwnProperty(l)) {
                                                    if (l == t) for (var a in i) i.hasOwnProperty(a) && (o[a] = i[a]);
                                                    o[l] = r[l];
                                                }
                                            return (
                                    ...
                                    highlightElement: function (i, n, r) {
                                        ...
                                        l && ((a = (l.className.match(e) || [, ""])[1].toLowerCase()), (o = s.languages[a])),
                                        ...
                                        if ((s.hooks.run("before-sanity-check", h), !h.code || !h.grammar))
                                            return h.code && (s.hooks.run("before-highlight", h), (h.element.textContent = h.code), s.hooks.run("after-highlight", h)), void s.hooks.run("complete", h);
                                        if ((s.hooks.run("before-highlight", h), n && t.Worker)) {
                                    ...
                                    highlight: function (e, t, i) {
                                        ...
                                        return s.hooks.run("before-tokenize", r), (r.tokens = s.tokenize(r.code, r.grammar)), s.hooks.run("after-tokenize", r), n.stringify(s.util.encode(r.tokens), r.language);
                                    },
                                        ...
                                        for (var h in i)
                                            if (i.hasOwnProperty(h) && i[h]) {
                                                ...
                                                for (var p = 0; p < c.length; ++p) {
                                                    ...
                                                    d = d.pattern || d;
                                                    for (var v = n, x = r; v < t.length; x += t[v].length, ++v) {
                                                        var P = t[v];
                                                        ...
                                                        if (!(P instanceof l)) {
                                                            if (f && v != t.length - 1) {
                                                                ...
                                                                for (var k = T.index + (m ? T[1].length : 0), E = T.index + T[0].length, w = v, C = x, z = t.length; w < z && (C < E || (!t[w].type && !t[w - 1].greedy)); ++w)
                                                                    k >= (C += t[w].length) && (++v, (x = C));
                                                                if (t[v] instanceof l) continue;
                                                                (Z = w - v), (P = e.slice(x, C)), (T.index -= x);
                                                            } else {
                                                                d.lastIndex = 0;
                                                                var T = d.exec(P),
                                                                    Z = 1;
                                ...
                                n = (s.Token = function (e, t, i, s, n) {
                                    (this.type = e), (this.content = t), (this.alias = i), (this.length = 0 | (s || "").length), (this.greedy = !!n);
                                });
                            if (
                                ((n.stringify = function (e, t, i) {
                                    ...
                                    if ("Array" === s.util.type(e))
                                        return e
                                            ...
                                            .join("");
                                    var r = { type: e.type, content: n.stringify(e.content, t, i), tag: "span", classes: ["token", e.type], attributes: {}, language: t, parent: i };
                                    if (e.alias) {
                            ...
                            i.languages.insertBefore(
                                ...
                                "attr-value",
                                {
                                    "style-attr": {
                                        ...
                                        inside: { "attr-name": { pattern: /^\s*style/i, inside: i.languages.markup.tag.inside }, punctuation: /^\s*=\s*['"]|['"]\s*$/, "attr-value": { pattern: /.+/i, inside: i.languages.css } },
                                        alias: "language-css",
                                    },
                                },
                        ...
                        "undefined" != typeof self &&
                            ...
                            ((self.Prism.fileHighlight = function () {
                                ...
                                Array.prototype.slice.call(document.querySelectorAll("pre[data-src]")).forEach(function (t) {
                                    for (var s, n = t.getAttribute("data-src"), r = t, a = /\blang(?:uage)?-([\w-]+)\b/i; r && !a.test(r.className); ) r = r.parentNode;
                                    if ((r && (s = (t.className.match(a) || [, ""])[1]), !s)) {
                                        var o = (n.match(/\.(\w+)$/) || [, ""])[1];
                                        s = e[o] || o;
                                    }
                                        ...
                                        (h.onreadystatechange = function () {
                                            4 == h.readyState &&
                                                (h.status < 400 && h.responseText
                                                    ? ((l.textContent = h.responseText), i.highlightElement(l))
                                                    : h.status >= 400
                                    ...
                                    i.plugins.toolbar &&
                                        i.plugins.toolbar.registerButton("download-file", function (e) {
                                            ...
                                            if (t && /pre/i.test(t.nodeName) && t.hasAttribute("data-src") && t.hasAttribute("data-download-link")) {
                                                ...
                                                return (s.textContent = t.getAttribute("data-download-link-label") || "Download"), s.setAttribute("download", ""), (s.href = i), s;
                                            }
                                        });
                            }),
        ...
        return class {
            ...
            startEditor() {
                if (!r(n, null, this.opts.styleParent)) throw Error("Failed to inject CodeFlask CSS.");
            ...
            updateLineNumbersCount() {
                let e = "";
                for (let t = 1; t <= this.lineNumber; t++) e += `<span class="codeflask__lines__line">${t}</span>`;
            ...
            listenTextarea() {
                this.elTextarea.addEventListener("input", (e) => {
                    ...
                    this.elTextarea.addEventListener("keydown", (e) => {
                        this.handleTabs(e), this.handleSelfClosingCharacters(e), this.handleNewLineIndentation(e);
                    }),
                    this.elTextarea.addEventListener("scroll", (e) => {
                        (this.elPre.style.transform = `translate3d(-${e.target.scrollLeft}px, -${e.target.scrollTop}px, 0)`), this.elLineNumbers && (this.elLineNumbers.style.transform = `translate3d(0, -${e.target.scrollTop}px, 0)`);
                    });
            }
            handleTabs(e) {
                if (this.opts.handleTabs) {
                    ...
                    this.updateCode(s), (this.elTextarea.selectionEnd = i + this.opts.tabSize);
                }
            }
            ...
            closeCharacter(e) {
                ...
                this.updateCode(s), (this.elTextarea.selectionEnd = i);
            }
            updateCode(e) {
    ...
    (PZ.ui.shader = function (e, t) {
        PZ.ui.panel.call(this, e),
            ...
            (this.shaderErrorHandler = (e) => {
                (this.statusEl.innerText = e), (this.statusEl.title = e);
            }),
...
(PZ.ui.graph = class extends PZ.ui.panel {
    constructor(e, t) {
        super(e),
            ...
            this.onObjectsChanged.watch((e) => {
                e && (e.onObjectAdded.unwatch(this.objectAdded_bound), e.onObjectRemoved.unwatch(this.objectRemoved_bound)),
                    this.objects ? (this.objects.onObjectAdded.watch(this.objectAdded_bound), this.objects.onObjectRemoved.watch(this.objectRemoved_bound)) : this.objectsChanged();
            }),
            (this.selection = new PZ.objectList()),
            (this.properties = new PZ.objectList(null, Object)),
            (this.options = { curveLineWidth: 2, keyframeSize: 8, handleSize: 8, cursorLineWidth: 1, shapeRendering: "auto" }),
            (this.width = 1),
            (this.height = 1),
            (this.centerX = 0),
            (this.centerY = 0),
    ...
    updateViewBox() {
        let e = this.centerX - 0.5 * this.width * this.zoomX,
            t = this.centerY - 0.5 * this.height * this.zoomY,
        ...
        for (let e = 2; e < this.svg.children.length - 1; e++) {
            let t = this.svg.children[e],
                ...
                s = t.children[1],
                n = t.children[2];
            this.updateCurve(i.firstElementChild, null, s.firstElementChild.pz_object), this.updateCurve(i.lastElementChild, s.lastElementChild.pz_object, null);
            for (let e = 0; e < s.children.length; e++) this.updateKeyframe(s.children[e]);
            for (let e = 0; e < n.children.length; e++) this.updateHandles(n.children[e]);
        }
    }
    createGraph() {
    ...
    mouseWheel(e) {
        let t = 1;
        e.deltaY < 0 ? (t = 0.95) : e.deltaY > 0 && (t = 1.05), e.ctrlKey || (this.zoomX *= t), e.shiftKey || (this.zoomY *= t), this.updateViewBox(), e.preventDefault();
    }
    keyframeDragStart(e) {
        this.ctx.el.focus();
        let t = this.ctx.svg,
    ...
    keyframeDrag(e) {
        (this.currentPt.x = e.pageX - this.origin.x), (this.currentPt.y = e.pageY - this.origin.y), (this.updateFrame = !e.ctrlKey), (this.updateValue = !e.shiftKey);
    }
    keyframeDragUpdate() {
        ...
        (this.deltaFrames = i - this.lastFrame), (this.lastFrame = i), (this.deltaUnits = s - this.lastValue), (this.lastValue = s);
        for (let e = 0; e < this.keyframeEls.length; e++) {
            let t = this.keyframeEls[e],
                n = t.pz_object,
                r = t.parentElement.parentElement.pz_valueScale;
            this.updateFrame && (n.frame = Math.round(t.pz_oldFrame + (i - this.startFrame))), this.updateValue && (n.value = t.pz_oldValue + (s - this.startValue) / r);
            ...
            this.ctx.updateKeyframe(t), this.ctx.updateHandles(t.pz_handles), this.ctx.updateCurve(t.pz_curveLeft, a, n), this.ctx.updateCurve(t.pz_curveRight, n, o);
        }
    }
    keyframeDragEnd(e) {
    ...
    finishMovingKeyframes(e) {
        ...
        for (let i = 0; i < t.length; i++) {
            ...
            for (let e = 0; e < s.length; e++) {
                ...
                (r[e].oldFrame = i), (r[e].newFrame = t), a.set(r[e], s[e].pz_object);
            }
            ...
            for (let e = 0; e < r.length; e++) {
                let t = s[e].pz_oldValue,
                    i = s[e].pz_object.frame;
                this.editor.history.pushCommand(PZ.ui.properties.prototype.setValue.bind(this), { property: r[e].property, value: t, frame: i });
            }
        }
    }
    handleDragStart(e) {
    ...
    handleDrag(e) {
        (this.currentPt.x = e.pageX - this.origin.x), (this.currentPt.y = e.pageY - this.origin.y), (this.breakTangent = e.shiftKey);
    }
    handleDragUpdate() {
        if (!this.moved && Math.abs(this.currentPt.x - this.startPt.x) + Math.abs(this.currentPt.y - this.startPt.y) < 4) return;
        this.moved = true;
        ...
        for (let e = 0; e < this.keyframeEls.length; e++) {
            ...
            if ((0 === this.cpIdx ? (a[0] = Math.min(o, 0)) : (a[0] = Math.max(o, 0)), (a[1] = t.pz_oldControlPoints[this.cpIdx][1] + (s - this.startValue) / r), n.continuousTangent && !this.breakTangent)) {
                let e = n.controlPoints[1 & ~this.cpIdx],
                    t = Math.sqrt(Math.pow(a[0], 2) + Math.pow(a[1], 2)),
                    i = Math.atan2(a[1], a[0]) + Math.PI;
                (e[0] = t * Math.cos(i)), (e[1] = t * Math.sin(i));
            }
            ...
            this.ctx.updateHandles(t.pz_handles), this.ctx.updateCurve(t.pz_curveLeft, l, n), this.ctx.updateCurve(t.pz_curveRight, n, h);
        }
    }
    handleDragEnd(e) {
    ...
    onKeyframeCreated(e, t) {
        ...
        for (; r && !(r.pz_object.frame >= n); ) r = r.nextElementSibling;
        s.insertBefore(i, r), this.updateKeyframe(i);
        let a = e.children[0],
        ...
        o
            ? l
                ...
                : ((i.pz_curveLeft = o.pz_curveRight), (i.pz_curveRight = this.createCurve()), a.appendChild(i.pz_curveRight), this.updateCurve(i.pz_curveLeft, o.pz_object, i.pz_object), this.updateCurve(i.pz_curveRight, i.pz_object, null))
            : l
            ? ((i.pz_curveLeft = this.createCurve()),
              (i.pz_curveRight = l.pz_curveLeft),
              a.insertBefore(i.pz_curveLeft, i.pz_curveRight),
    ...
    onKeyframeDeleted(e, t) {
        ...
        for (; i && i.pz_object !== t; ) i = i.nextElementSibling;
        if (!i) return;
        let s = i.previousElementSibling,
            n = i.nextElementSibling;
        s
            ? (i.pz_curveRight.remove(), n ? ((n.pz_curveLeft = s.pz_curveRight), this.updateCurve(i.pz_curveLeft, s.pz_object, n.pz_object)) : this.updateCurve(i.pz_curveLeft, s.pz_object, null))
            : (i.pz_curveLeft.remove(), n ? this.updateCurve(i.pz_curveRight, null, n.pz_object) : i.pz_curveRight.remove()),
            i.pz_handles && i.pz_handles.remove(),
            i.remove();
    }
    onKeyframeMoved(e, t, i) {
        this.onKeyframeDeleted(e, i), this.onKeyframeCreated(e, i);
    }
    onKeyframeChanged(e, t) {
        ...
        this.updateKeyframe(i), this.updateCurve(i.pz_curveLeft, s, n), this.updateCurve(i.pz_curveRight, n, r), i.pz_handles && this.updateHandles(i.pz_handles);
    }
    createHandles(e) {
    ...
    updateHandles(e) {
        ...
        let n = e.children[0];
        n.setAttributeNS(null, "rx", 0.5 * s * this.zoomX), n.setAttributeNS(null, "ry", 0.5 * s * this.zoomY), n.setAttributeNS(null, "cx", t.controlPoints[0][0]), n.setAttributeNS(null, "cy", -t.controlPoints[0][1] * i);
        let r = e.children[1];
        r.setAttributeNS(null, "rx", 0.5 * s * this.zoomX), r.setAttributeNS(null, "ry", 0.5 * s * this.zoomY), r.setAttributeNS(null, "cx", t.controlPoints[1][0]), r.setAttributeNS(null, "cy", -t.controlPoints[1][1] * i);
        let a = e.children[2];
        a.setAttributeNS(null, "x1", "0"), a.setAttributeNS(null, "y1", "0"), a.setAttributeNS(null, "x2", t.controlPoints[0][0]), a.setAttributeNS(null, "y2", -t.controlPoints[0][1] * i);
        let o = e.children[3];
        o.setAttributeNS(null, "x1", "0"), o.setAttributeNS(null, "y1", "0"), o.setAttributeNS(null, "x2", t.controlPoints[1][0]), o.setAttributeNS(null, "y2", -t.controlPoints[1][1] * i);
    }
    createKeyframe(e) {
    ...
    updateKeyframe(e) {
        ...
        e.setAttributeNS(null, "width", s * this.zoomX), e.setAttributeNS(null, "height", s * this.zoomY), e.setAttributeNS(null, "x", t.frame - 0.5 * s * this.zoomX), e.setAttributeNS(null, "y", -t.value * i - 0.5 * s * this.zoomY);
    }
    selectKeyframe(e) {
        e.classList.contains("selected") ||
            ((e.pz_handles = this.createHandles(e.pz_object)), e.parentElement.parentElement.children[2].appendChild(e.pz_handles), this.updateHandles(e.pz_handles), e.classList.add("selected"), e.setAttributeNS(null, "fill", "#ccc"));
    }
    deselectKeyframe(e) {
        e.classList.contains("selected") && (e.pz_handles.remove(), (e.pz_handles = null), e.classList.remove("selected"), e.setAttributeNS(null, "fill", "#000"));
    }
    deselectAllKeyframes() {
        let e = this.svg.getElementsByClassName("selected");
        for (; e.length; ) this.deselectKeyframe(e[0]);
    }
    createCurve(e, t) {
        let i = document.createElementNS(SVGNS, "path");
        return i.setAttributeNS(null, "vector-effect", "non-scaling-stroke"), i;
    }
    updateCurve(e, t, i) {
        let s,
            n,
            r,
            a,
            o = e.parentElement.parentElement.pz_valueScale,
            l = e.parentElement.parentElement.pz_frameOffset;
        if (t) s = `${t.frame} ${-t.value * o}`;
        else {
            s = `${Math.min(this.centerX - l - 0.5 * this.width * this.zoomX, i.frame)} ${-i.value * o}`;
        }
        if (i) a = `${i.frame} ${-i.value * o}`;
        else {
            a = `${Math.max(this.centerX - l + 0.5 * this.width * this.zoomX, t.frame)} ${-t.value * o}`;
        }
        if (t && i && i.tween >> 8) {
        ...
        } else e.setAttributeNS(null, "d", `M ${s} L ${a}`);
    }
    ...
    createProperty(e) {
        let t = document.createElementNS(SVGNS, "g");
        (t.pz_object = e), (t.pz_frameOffset = 0), (t.pz_valueScale = 1 / (e.definition.scaleFactor || 1));
        let i = document.createElementNS(SVGNS, "g");
        i.setAttributeNS(null, "fill", "none"), i.setAttributeNS(null, "stroke-width", this.options.curveLineWidth + "px"), t.appendChild(i);
        let s = (t) => {
    ...
    objectAdded(e) {
        if (!(e instanceof PZ.property.dynamic.keyframes)) return;
    ...
    objectRemoved(e) {
        for (let t = 0; t < this.svg.children.length; t++) {
            ...
            if (i.pz_object === e) {
                this.unloadProperty(i), i.remove();
                break;
            }
        }
    }
    objectsChanged() {
        if (this.objects) for (let e = 0; e < this.objects.length; e++) this.createProperty(this.objects[e]);
    }
    create() {
        this.createGraph(),
            ...
            (this.svg_drag = new PZ.ui.drag(
                ...
                function (e) {
                    ...
                    if (((this.origin = { x: t.left, y: t.top }), (this.button = e.button), (this.startPt = { x: e.pageX - this.origin.x, y: e.pageY - this.origin.y }), (this.currentPt = { x: 0, y: 0 }), 0 === this.button)) {
                        ...
                        let i = this.ctx.centerX - 0.5 * this.ctx.width * this.ctx.zoomX,
                            s = this.ctx.centerY - 0.5 * this.ctx.height * this.ctx.zoomY;
                        (this.startX = this.startPt.x * this.ctx.zoomX + i), (this.startY = this.startPt.y * this.ctx.zoomY + s), (this.multiSelect = e.shiftKey);
                    }
                },
                function (e) {
                    (this.currentPt.x = e.pageX - this.origin.x), (this.currentPt.y = e.pageY - this.origin.y);
                ...
                function () {
                    if (0 === this.button) {
                        ...
                        this.selectEl.setAttributeNS(null, "x", n), this.selectEl.setAttributeNS(null, "y", r), this.selectEl.setAttributeNS(null, "width", a), this.selectEl.setAttributeNS(null, "height", o);
                        for (let e = 2; e < this.ctx.svg.children.length - 1; e++) {
                            ...
                            for (let e = 0; e < t.children.length; e++) {
                                let s = t.children[e],
                                    l = parseFloat(s.getAttribute("x")) + i + 0.5 * parseFloat(s.getAttribute("width")),
                                    h = parseFloat(s.getAttribute("y")) + 0.5 * parseFloat(s.getAttribute("height"));
                        ...
                        (this.ctx.editor.playback.speed = 0), (this.ctx.editor.playback.currentFrame = Math.max(Math.min(i, s - 1), 0));
                    }
                },
                function (e) {
    ...
    update() {
        (this.animFrameReq = requestAnimationFrame(this._updateFn)), this.cursor.setAttributeNS(null, "x1", this.editor.playback.currentFrame), this.cursor.setAttributeNS(null, "x2", this.editor.playback.currentFrame);
    }
    resize() {
        (this.width = this.el.clientWidth), (this.height = this.el.clientHeight), this.xGrid.resize(), this.yGrid.resize(), this.updateViewBox();
    }
    deleteKeyframes(e) {
        for (var t = 0; t < e.length; t++) {
    ...
    toggleContinuousTangents(e) {
        for (var t = 0; t < e.length; t++) {
            let i = e[t].parentElement.parentElement.pz_object,
                s = e[t].pz_object,
                n = { property: i.getAddress(), frame: s.frame, continuous: !s.continuousTangent };
    ...
    resetHandles(e) {
        ...
        for (var i = 0; i < e.length; i++) {
            let s = e[i].parentElement.parentElement.pz_object,
                n = e[i].pz_object,
                r = { property: s.getAddress(), frame: n.frame, controlPoints: t };
    ...
    async keydown(e) {
        if ("=" === e.key || "+" === e.key) {
            e.stopPropagation();
            const t = 0.95;
            e.ctrlKey || (this.zoomX *= t), e.shiftKey || (this.zoomY *= t), this.updateViewBox();
            ...
            for (let e = 2; e < this.svg.children.length - 1; e++) {
                ...
                for (let e = 0; e < r.children.length; e++) {
                    let o = r.children[e],
                        l = parseFloat(o.getAttribute("x")) + a + 0.5 * parseFloat(o.getAttribute("width")),
                        h = parseFloat(o.getAttribute("y")) + 0.5 * parseFloat(o.getAttribute("height"));
                    (t = Math.min(t, l)), (i = Math.max(i, l)), (s = Math.min(s, h)), (n = Math.max(n, h));
                }
            }
            if (t === Number.POSITIVE_INFINITY) return;
            (this.centerX = 0.5 * (t + i)), (this.centerY = 0.5 * (s + n)), i - t > 0 && (this.zoomX = (1.3 * (i - t)) / this.width), n - s > 0 && (this.zoomY = (1.3 * (n - s)) / this.height), this.updateViewBox();
        } else if ("Delete" === e.key || "Del" === e.key || "Backspace" === e.key) {
            e.stopPropagation();
            var t = this.svg.querySelectorAll(".selected");
            this.editor.history.startOperation(), this.deleteKeyframes(t), this.editor.history.finishOperation();
        } else if ("t" === e.key) {
            e.stopPropagation();
            t = this.svg.querySelectorAll(".selected");
            this.editor.history.startOperation(), this.toggleContinuousTangents(t), this.editor.history.finishOperation();
        } else if ("i" === e.key) {
            e.stopPropagation();
            t = this.svg.querySelectorAll(".selected");
            this.editor.history.startOperation(), this.toggleInterpolation(t), this.editor.history.finishOperation();
        } else if ("r" === e.key) {
            e.stopPropagation();
            t = this.svg.querySelectorAll(".selected");
            this.editor.history.startOperation(), this.resetHandles(t), this.editor.history.finishOperation();
        } else if (("c" !== e.key && "x" !== e.key) || !e.ctrlKey) {
            if ("v" === e.key && e.ctrlKey) {
                e.stopPropagation();
                let t = await navigator.clipboard.readText(),
                ...
                for (let e = 2; e < this.svg.children.length - 1; e++) {
                    ...
                    for (let e = 0; e < i.length; e++) {
                        ...
                        o && (this.propertyOps.pasteKeyframes(t, o, a), delete r[t.definition.name]);
                    }
                }
                this.editor.history.finishOperation();
            }
    ...
    (PZ.ui.graph.grid = class {
        constructor(e, t) {
            (this.graph = e), (this.numGridLines = 0), (this.numTexts = 0), (this.options = { gridUnit: 20, lineWidth: 1, dimension: 0, textSize: 10 }), Object.assign(this.options, t), this.create();
        }
        create() {
            (this.el = document.createElementNS(SVGNS, "g")), this.el.setAttributeNS(null, "stroke-width", this.options.lineWidth + "px"), this.graph.svg.appendChild(this.el);
        }
        createGridLine() {
            let e = document.createElementNS(SVGNS, "line");
            return e.setAttributeNS(null, "vector-effect", "non-scaling-stroke"), e;
        }
        createText() {
            let e = document.createElementNS(SVGNS, "text");
            return this.el.setAttributeNS(null, "fill", "#666"), (e.style = `font-size: ${this.options.textSize}; font-family: 'Source Code Pro'; color: #666`), e;
        }
        update() {
            if (0 === this.options.dimension) {
                let e = this.options.gridUnit * Math.pow(2, Math.ceil(Math.log2(this.graph.zoomX))),
                    t = this.graph.centerX - 0.5 * this.graph.width * this.graph.zoomX;
                t = Math.round(t / e);
                this.graph.width, this.graph.zoomX;
                let i = 0.5 * this.graph.height * this.graph.zoomY;
                for (let s = 0; s < this.numGridLines; s++) {
                    let n,
                        r = this.el.children[s],
                        a = (t + s) * e;
                    if ((s + t) & 1) n = "#333333";
                    else {
                        n = "#1e1e1e";
                        ...
                        e.setAttributeNS(null, "x", a / this.graph.zoomX + 5),
                            e.setAttributeNS(null, "y", this.graph.centerY / this.graph.zoomY + 0.5 * this.graph.height - 5),
                            (e.style.transform = `scale(${this.graph.zoomX}, ${this.graph.zoomY})`),
                            (e.textContent = a.toString());
                    }
                    r.setAttributeNS(null, "x1", a), r.setAttributeNS(null, "y1", this.graph.centerY + i), r.setAttributeNS(null, "x2", a), r.setAttributeNS(null, "y2", this.graph.centerY - i), r.setAttributeNS(null, "stroke", n);
                }
            } else {
                let e = this.options.gridUnit * Math.pow(2, Math.ceil(Math.log2(this.graph.zoomY))),
                    t = this.graph.centerY - 0.5 * this.graph.height * this.graph.zoomY;
                t = Math.round(t / e);
                this.graph.height, this.graph.zoomY;
                ...
                for (let s = 0; s < this.numGridLines; s++) {
                    ...
                    if ((s + t) & 1) n = "#333333";
                        ...
                        e.setAttributeNS(null, "y", a / this.graph.zoomY - 5),
                            e.setAttributeNS(null, "x", this.graph.centerX / this.graph.zoomX - 0.5 * this.graph.width + 5),
                            (e.style.transform = `scale(${this.graph.zoomX}, ${this.graph.zoomY})`),
                            (e.textContent = -a);
                    }
                    r.setAttributeNS(null, "y1", a), r.setAttributeNS(null, "x1", this.graph.centerX + i), r.setAttributeNS(null, "y2", a), r.setAttributeNS(null, "x2", this.graph.centerX - i), r.setAttributeNS(null, "stroke", n);
                }
            }
        }
        resize() {
            for (
                0 === this.options.dimension ? (this.numGridLines = Math.ceil(this.graph.width / this.options.gridUnit)) : (this.numGridLines = Math.ceil(this.graph.height / this.options.gridUnit)),
                    this.numTexts = Math.ceil(0.5 * this.numGridLines);
                this.el.firstElementChild;

            )
                this.el.firstElementChild.remove();
            for (let e = 0; e < this.numGridLines; e++) this.el.appendChild(this.createGridLine());
            for (let e = 0; e < this.numTexts; e++) this.el.appendChild(this.createText());
        }
    }),
    ...
    (PZ.compatibility = class {
        ...
        upgrade(e) {
            ...
            t < 22 && this.core22(e), t < 38 && this.core38(e), t < 43 && this.core43(e), t < 60 && this.core60(e), t < 64 && this.core64(e), t < 84 && this.core84(e), t < 96 && this.core96(e), t < 101 && this.core101(e);
        }
        core22(e) {
            let t = e.sequence,
                i = t.clipLinks.links;
            for (let e in i) for (let t of i[e].clips) t.splice(0, 0, 0), (t[1] += 1), t.splice(3, 0, 0);
            let s = (e) => {
                    e.forEach((e) => {
                        (e.properties.name = e.name), delete e.name;
                    }),
                ...
                r = t.videoTracks
                    ...
                    .concat(n);
            for (let e = 0; e < r.length; e++) {
                if (((r[e].properties = { name: r[e].name }), 0 === r[e].type && r[e].object && r[e].object.effects)) {
                ...
                0 === r[e].type && r[e].object && 4 === r[e].object.type
                    ? ((r[e].object.objects = r[e].object.group.objects), s(r[e].object.objects))
                    : 0 === r[e].type && r[e].object && 5 === r[e].object.type
                    ? ((r[e].object.type = 7),
                      (r[e].object.objects = [
                          {
                              type: 0,
                    ...
                    : 0 === r[e].type && r[e].object && r[e].object.type >= 6 && ((r[e].object.objects = [r[e].object.group]), s(r[e].object.objects));
            }
        }
        core38(e) {
            let t = (e) => {
            ...
            for (let e = 0; e < i.length; e++) !i[e].object || (4 !== i[e].object.type && 2 !== i[e].object.type) || t(i[e].object.objects);
        }
        core43(e) {
            let t = e.sequence;
            for (let e = 0; e < t.videoTracks.length; e++) t.videoTracks[e].type = 0;
            for (let e = 0; e < t.audioTracks.length; e++) t.audioTracks[e].type = 1;
        ...
        core60(e) {
            for (let t = e.media.length - 1; t >= 0; t--) {
                let i = e.media[t];
                i ? ((i.properties = { name: i.title, icon: i.icon }), delete i.title, delete i.icon) : e.media.splice(t, 1);
            }
        }
        core64(e) {
            let t = e.sequence,
                ...
                n = t.videoTracks
                    ...
                    .concat(s),
                r = (e, t) => {
                    for (let i = 0; i < e.keyframes.length; i++) e.keyframes[i].frame += t;
                },
                a = (e, t) => {
                    for (let i in e) {
                        let s = e[i];
        ...
        core96(e) {
            ...
            for (let e = 0; e < t.length; e++) t[e].object && 4 === t[e].object.type && i(t[e].object);
        }
        core101(e) {
            let t = e.sequence.videoTracks.map((e) => e.clips).reduce((e, t) => e.concat(t), []),
                i = (e) => {
                                ...
                                if (Array.isArray(e)) {
                                    ...
                                    if (void 0 !== e.objects) {
                                        ...
                                        for (let e = 0; e < i.length; e++) {
                                            ...
                                            n.push(JSON.parse(`{"value":${t[0]},"frame":${s},"tween":${a},"controlPoints":${o}}`)), r.push(JSON.parse(`{"value":${t[1]},"frame":${s},"tween":${a},"controlPoints":${o}}`));
                                        }
                                    }
                            }
                        } else i(s);
    ...
    (PZ.compatibility.CM2 = function (e) {
        (this.archive = e), (this.project = JSON.parse(JSON.stringify(CM.defaultProject))), (this.project.media = []), (this.sequence = this.project.sequence);
    }),
    ...
    (PZ.compatibility.CM2.prototype.createAssetFromFile = async function (e, t) {
        ...
        return (i.type = e), (i.source = PZ.asset.source.FILE), (i.sha256 = await PZ.asset.hash(t)), (i.filename = t.name || ""), (i.size = t.size), (this.project.assets[i.sha256] = i), this.archive.addFile(i.sha256, t), i;
    }),
    ...
    (PZ.compatibility.CM2.prototype.migrateProperties = function (e, t) {
        ...
        function s(e) {
            ...
            let t = [],
                i = Object.keys(e);
            for (let s = 0; s < i.length; s++) t.push(e[i[s]]);
            return t;
        }
        function n(e, n, r) {
            let a = n[r];
    ...
    (PZ.compatibility.CM2.prototype.loadObject = async function (e, t) {
        ...
        if (0 === e) {
            if (0 === s.objectType) return;
            if (99 === s.objectType) {
                if (!(a = this.archive.getFileBlob(t + "_geometry"))) return;
            ...
            3 === s.objectType || 6 === s.objectType ? delete s.normalProps.size.z : (4 !== s.objectType && 5 !== s.objectType) || (s.normalProps.size = s.normalProps.size.x),
                ...
                7 !== s.objectType && (delete s.normalProps.loops, delete s.normalProps.thickness),
                99 === s.objectType && (delete s.normalProps.size, delete s.normalProps.detail),
            ...
            (s.normalProps.font = this.fonts[s.normalProps.font] || null),
                (n = function (e) {
                    if ("bevelsize" === e) return "bevelSize";
                });
        } else if (2 === e)
            n = function (e) {
            ...
            if ("darkness" === e) return void (this.hemiLightIntensity = s.intensity);
            if ("sky" === e) s.textures = s.textures || [];
            else if ("duplicate" === e)
                ...
                let e = [0, 1, 1],
                    t = [1, 0, 1];
                (s.keyframeProps.horizontal = []), (s.keyframeProps.vertical = []);
                for (let i = 0; i < s.keyframeProps.mode.length; i++) {
                    let n = s.keyframeProps.mode[i];
                    s.keyframeProps.horizontal.push(Object.assign({}, n)), (s.keyframeProps.horizontal[i].value = t[n.value]), s.keyframeProps.vertical.push(Object.assign({}, n)), (s.keyframeProps.vertical[i].value = e[n.value]);
                }
                ...
                (s.normalProps.blending = e[s.normalProps.blending]), (s.normalProps.repeat = 0);
            } else if ("radialblur" === e) s.normalProps = { overbright: 1 };
            else if ("rgbshift" === e) {
                let e = this.sequence.properties.resolution,
                    t = Math.sqrt(e[0] * e[0] + e[1] * e[1]);
                for (let e = 0; e < s.keyframeProps.amount.length; e++) s.keyframeProps.amount[e].value *= t;
            }
        }
        if ((await this.loadTextures(s, t), s.appearanceObj && ((s.material = await this.loadObject(s.appearanceObj, t + "_appearance")), delete s.appearanceObj), this.migrateProperties(s, n), s.objects))
            for (var l = 0; l < s.objects.length; l++) s.objects[l] = await this.loadObject(s.objects[l], t + "_" + l);
        return s;
    }),
    ...
    (PZ.compatibility.CM2.prototype.loadTextures = async function (e, t) {
        if (4 === e.type) {
            ...
            var s;
            e.image ? ((s = e.image), delete e.image) : (s = t + "_img"), (e.normalProps.texture = await this.loadTexture(s));
        } else if (t.startsWith("fx")) this.archive.fileExists(t + "_img0") && (e.normalProps.texture = await this.loadTexture(t + "_img0"));
            ...
            e.textures = [];
            for (var n = 0; n < 6; n++) this.archive.fileExists(t + "_img" + n) && (e.textures[n] = await this.loadTexture(t + "_img1"));
        }
    }),
    ...
    (PZ.compatibility.CM2.prototype.loadHemiLight = function () {
        if (0 !== this.hemiLightIntensity) {
            ...
            (e.keyframeProps = { intensity: [{ frame: 0, value: this.hemiLightIntensity, tweenfn: 1 }] }), this.sequence.videoTracks[0].clips[0].object.objects.push(e);
        }
    }),
    (PZ.compatibility.CM2.prototype.loadAudio = async function () {
        ...
        this.sequence.audioTracks[0].clips.push(n), (n.start = 0), (n.length = this.sequence.length), (n.properties.media = t.sha256);
        ...
        if (
            ...
            if (s.fadeOut > 0) {
                ...
                o.push({ frame: p, value: 1, tweenfn: 1 }), o.push({ frame: c, value: 0, tweenfn: 1 });
            }
        } else for (let e = 0; e < n.object.keyframeProps.volume.length; e++) n.object.keyframeProps.volume[e].value /= 100;
        this.migrateProperties(n.object);
    }),
    (PZ.compatibility.BG4 = function (e) {
        (this.archive = e), (this.project = JSON.parse(JSON.stringify(CM.defaultProject))), (this.sequence = this.project.sequence);
    }),
    ...
    (PZ.ui.playbackDebug = function (e) {
        PZ.ui.panel.call(this, e), (this.graphX = 0), this.create(), (this._updateFn = this.update.bind(this)), (this.animFrameReq = requestAnimationFrame(this._updateFn));
    }),
    (PZ.ui.playbackDebug.prototype.create = function () {
        (this.canvas = document.createElement("canvas")), (this.canvas.width = 4), (this.canvas.height = 4), this.el.appendChild(this.canvas);
    }),
    (PZ.ui.playbackDebug.prototype.resize = function () {
        (this.canvas.width = this.el.clientWidth), (this.canvas.height = this.el.clientHeight);
    }),
    (PZ.ui.playbackDebug.prototype.printLine = function (e, t) {
        e.fillText(t, 0, 16), e.translate(0, 16);
    }),
    ...
    (PZ.ui.playbackDebug.prototype.update = function () {
        ...
        i.clearRect(0, 0, this.canvas.width, 0.5 * this.canvas.height), i.save(), (i.fillStyle = "#ccc"), (i.font = "16px Source Code Pro");
        for (var s = 0; s < this.editor.sequence.videoSchedules.length; s++) {
            var n = this.editor.sequence.videoSchedules[s];
            if ((this.printLine(i, "video schedule " + s), n.el && n.currentItem)) {
        ...
        for (s = 0; s < this.editor.sequence.audioSchedules.length; s++) {
            ...
            if ((this.printLine(i, "audio schedule " + s), n.el && n.currentItem)) {
        ...
        i.restore(),
            (e /= t),
            (i.fillStyle = "black"),
            i.fillRect(this.graphX, 0.5 * this.canvas.height, 1, 0.5 * this.canvas.height),
            (i.fillStyle = "red"),
            i.fillRect(this.graphX, this.canvas.height - 0.5 * this.canvas.height * e - 1, 1, 1),
