...
if (!THREE.BoxBlurPass) {
    THREE.BoxBlurPass = function (material_h, material_v) {
        this.material_h = material_h;
        this.material_v = material_h.clone();
...
this.load = async function (e) {
    ...
    this.pass = new THREE.BoxBlurPass(t);
