this.defaultName = "Box Blur", this.shaderfile = "fx_boxblur", this.propertyDefinitions = {
    enabled: {
        dynamic: !0,
        name: "Enabled",
...
}, this.properties.addAll(this.propertyDefinitions, this), THREE.BoxBlurPass || (THREE.BoxBlurPass = function(e, t) {
    ...
    render: function(e, t, s, a) {
        this.quad.material = this.material_v, this.uniforms.tDiffuse.value = s.texture, e.render(this.scene, this.camera, t, a), this.quad.material = this.material_h, this.uniforms.tDiffuse.value = t.texture, e.render(this.scene, this.camera, s, a)
    }
}), this.shaderUrl = "/assets/shaders/fragment/" + this.shaderfile + ".glsl", this.vertShader = this.parentProject.assets.createFromPreset(PZ.asset.type.SHADER, "/assets/shaders/vertex/common.glsl"), this.fragShader = this.parentProject.assets.createFromPreset(PZ.asset.type.SHADER, this.shaderUrl), this.load = async function(e) {
    ...
    this.pass = new THREE.BoxBlurPass(t), this.properties.load(e && e.properties)
