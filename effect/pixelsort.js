...
(this.propertyDefinitions = {
    ...
    threshold: { dynamic: true, name: "Threshold", type: PZ.property.type.NUMBER, value: 1, max: 1, min: 0, step: 0.01, decimals: 3 },
    direction: {
        name: "Direction",
        ...
        changed: function () {
            ...
            (e.pass.sortPass.defines.DIRECTION = this.value), (e.pass.sortPass.needsUpdate = true), (e.pass.drawPass.defines.DIRECTION = this.value), (e.pass.drawPass.needsUpdate = true);
        },
    },
    reverse: {
        name: "Reverse",
        ...
        changed: function () {
            let e = this.parentObject;
            (e.pass.sortPass.defines.REVERSE = this.value), (e.pass.sortPass.needsUpdate = true);
        },
    },
    affect: {
        name: "Affect",
        ...
        changed: function () {
            let e = this.parentObject;
            (e.pass.sortPass.defines.AFFECT = this.value), (e.pass.sortPass.needsUpdate = true);
        },
    },
}),
...
(this.load = async function (e) {
    ...
    let t = { tDiffuse: { type: "t", value: null }, tMap: { type: "t", value: null }, uvScale: { type: "v2", value: new THREE.Vector2(1, 1) }, threshold: { type: "f", value: 0.5 } },
        s = new THREE.ShaderMaterial({ uniforms: t, defines: { PASS_MAP: true, DIRECTION: 0, AFFECT: 0, REVERSE: 0 }, vertexShader: await this.vertShader.getShader(), fragmentShader: await this.fragShader.getShader() }),
