...
this.propertyDefinitions= {
    ...
    ,
    threshold: {
        dynamic:  !0, name:"Threshold", type:PZ.property.type.NUMBER, value:1, max:1, min:0, step:.01, decimals:3
    }
    ,
    direction: {
        name: "Direction", type:PZ.property.type.OPTION, value:0, items:"vertical;horizontal", changed:function() {
            let e=this.parentObject;
            e.pass.sortPass.defines.DIRECTION=this.value,
            e.pass.sortPass.needsUpdate= !0,
            e.pass.drawPass.defines.DIRECTION=this.value,
            e.pass.drawPass.needsUpdate= !0
        }
    }
    ,
    reverse: {
        name: "Reverse", type:PZ.property.type.OPTION, value:0, items:"off;on", changed:function() {
            let e=this.parentObject;
    ...
    ,
    affect: {
        name: "Affect", type:PZ.property.type.OPTION, value:0, items:"shadows;highlights", changed:function() {
            let e=this.parentObject;
...
THREE.PixelSortPass||(THREE.PixelSortPass=function(e, t, s) {
    ...
    ;
    this.renderTarget=new THREE.WebGLRenderTarget(32, 32, r), this.renderTarget.texture.generateMipmaps= !1, this.enabled= !0, this.needsSwap= !0, this.oldClearColor=new THREE.Color, this.oldClearAlpha=1, this.camera=new THREE.OrthographicCamera(-1, 1, 1, -1, 0, 1), this.scene=new THREE.Scene, this.quad=new THREE.Mesh(new THREE.PlaneBufferGeometry(2, 2), null), this.scene.add(this.quad)
}

, THREE.PixelSortPass.prototype=Object.assign(Object.create(THREE.Pass.prototype), {
    constructor:THREE.PixelSortPass, dispose:function() {
...
this.load=async function(e) {
    ...
    s=new THREE.ShaderMaterial( {
        uniforms:t, defines: {
            PASS_MAP:  !0, DIRECTION:0, AFFECT:0, REVERSE:0
        }
