...
if (!THREE.ALFPass) {
    THREE.ALFPass = function (resolution, strength, radius, threshold) {
        ...
        if (THREE.LuminosityHighPassShader === undefined) {
            console.error(
                "THREE.ALFPass relies on THREE.LuminosityHighPassShader"
            );
        }
        ...
        for (l = 0; l < this.nMips; l++) {
            this.separableBlurMaterials.push(
                this.getSeperableBlurMaterial(h[l])
            );
    ...
    THREE.ALFPass.prototype = Object.assign(
...
this.load = function (t) {
    this.pass = new THREE.ALFPass(new THREE.Vector2(1, 1), 1.5, 0.4, 0.85);
