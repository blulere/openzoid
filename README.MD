...
## Current issues
- There is a memory leaking issue that causes performance issues over time, but currently it is unknown whether this is caused by unminified branch, archive branch, or Clipmaker 3.
